...
namespace Modules\TitanLeads\Services\Email;

use Exception;
use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Mail;
use Modules\TitanLeads\Models\EmailChannel;
...
class EmailSenderService
{
    ...
    {
        $this->emailChannel = EmailChannel::query()
    ...
    public function send(string $to, string $subject, string $body): array
    {
        ...
        // Optional per-user SMTP override
