...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table(self::$prefix . '_operator_bots', function (Blueprint $table) {
            if (Schema::hasColumn(self::$prefix . '_operator_bots', 'interaction_type')) {
                return;
            }

            $table->string('interaction_type')->nullable()
                ->default('automatic_response')
                ->after('user_id');
        ...
        Schema::table(self::$prefix . '_operator_conversations', function (Blueprint $table) {
            if (! Schema::hasColumn(self::$prefix . '_operator_conversations', 'connect_agent_at')) {
        ...
        Schema::table(self::$prefix . '_operator_messages', function (Blueprint $table) {
            if (Schema::hasColumn(self::$prefix . '_operator_messages', 'user_id')) {
                return;
            }
