...
use Modules\TitanTalk\Http\Controllers\TeamInboxController;
...
Route::middleware(['web','auth'])->prefix('aiconverse')->group(function () {
    ...
    Route::get('/team-inbox', [TeamInboxController::class, 'index'])->name('titantalk.team-inbox');
    Route::post('/team-inbox/{conversation}/reply', [TeamInboxController::class, 'reply'])->name('titantalk.team-inbox.reply');
});
