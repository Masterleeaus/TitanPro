...
class GenerateAccountantExportPackAction
{
    public function __construct(protected StatementExportService $exports) {}

    public function execute(array $data = []): array
    {
        $result = $this->exports->accountantPack($data);

        Event::dispatch(new StatementGenerated([
