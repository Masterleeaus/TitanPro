...
use Modules\CallingAgent\Http\Controllers\Api\TitanEchoVoiceApiController;
...
Route::middleware(['api'])
    ...
    ->group(function () {
        ...
        // TitanEchoVoice API
        Route::get('/titan-echo-voice/{id}', [TitanEchoVoiceApiController::class, 'show'])
            ->name('titan-echo-voice.show');
    });
