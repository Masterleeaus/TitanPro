...
class EInvoiceServiceProvider extends ServiceProvider
{
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(__DIR__ . '/../Config/config.php', 'einvoice');
        $this->mergeConfigFrom(__DIR__ . '/../Config/ai.php', 'einvoice.ai');
        $this->mergeConfigFrom(__DIR__ . '/../Config/zeropay.php', 'einvoice.zeropay');
        $this->mergeConfigFrom(__DIR__ . '/../Config/titanzero.php', 'einvoice.titanzero');
        $this->mergeConfigFrom(module_path('EInvoice', 'Config/xss_ignore.php'), 'einvoice::xss_ignore');
    }
