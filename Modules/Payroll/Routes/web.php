...
use Modules\Payroll\Http\Controllers\Web\PayslipSecureDownloadController;


Route::get('payroll/payslips/secure-download/{token}', PayslipSecureDownloadController::class)
    ->middleware(['web', 'signed'])
    ->name('payroll.payslips.secure-download');
