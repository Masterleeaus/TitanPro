...
namespace Modules\CleaningJobs\Models\PlanningCore;
...
class Project extends Model implements AuditableContract
{
    ...
    public static function generateProjectCode(string $name): string
    {
        ...
        // Get settings
        $autoGenerate = $settingsService->get('PlanningCore', 'auto_generate_codes', true);
        $prefixLength = (int) $settingsService->get('PlanningCore', 'code_prefix_length', '3');
        $separator = $settingsService->get('PlanningCore', 'code_separator', '-');
