...
class   Task extends Model
{
    ...
    {
        return \Workdo\JobBoard\Database\factories\TaskFactory::new();
    }
    protected $fillable = [
        'title',
        'priority',
    ...
    {
        return $this->hasMany('Modules\CleaningJobs\Models\JobBoard\Comment', 'task_id', 'id')->orderBy('id', 'DESC');
    }

    public function taskFiles()
    {
        return $this->hasMany('Modules\CleaningJobs\Models\JobBoard\TaskFile', 'task_id', 'id')->orderBy('id', 'DESC');
    }

    public function milestones()
    {
        return $this->hasOne('Modules\CleaningJobs\Models\JobBoard\Milestone', 'id', 'milestone_id');
    }
    ...
    {
        return $this->hasOne('Modules\CleaningJobs\Models\JobBoard\Stage', 'id', 'status');
    }

    public function sub_tasks()
    {
        return $this->hasMany('Modules\CleaningJobs\Models\JobBoard\SubTask', 'task_id', 'id')->orderBy('id', 'DESC');
    }
