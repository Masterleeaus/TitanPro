...
{
    protected $signature = 'cleaningjobs:import-csv {path} {--dry-run}';
    protected $description = 'Import Cleaning Jobs from a CSV with headers: id,title,status,priority,customer_id,scheduled_at,created_at,updated_at';
