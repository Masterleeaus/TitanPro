...
{
    protected $signature = 'cleaningjobs:uninstall {--dry-run} {--force} {--drop-tables}';
    protected $description = 'Safely uninstall Cleaning Jobs: revoke permissions, remove seeds; optionally drop tables.';
    ...
    public function handle(): int
    {
        ...
        $perms = ['cleaningjobs.view','cleaningjobs.create','cleaningjobs.update','cleaningjobs.delete','cleaningjobs.settings'];
