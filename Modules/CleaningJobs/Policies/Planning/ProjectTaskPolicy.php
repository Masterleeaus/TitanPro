...
class ProjectTaskPolicy
{
    ...
    public function viewAny(User $user, Project $project): bool
    {
        ...
        return $user->can('planning.view-project-tasks') &&
    ...
    {
        if (! $user->can('planning.view-project-tasks')) {
            return false;
        }
    ...
    {
        return $user->can('planning.create-project-task') &&
               app(ProjectPolicy::class)->view($user, $project);
    }
    ...
    public function update(User $user, Task $task): bool
    {
        ...
        if ($user->can('planning.edit-project-task')) {
            return app(ProjectPolicy::class)->view($user, $project);
        }

        if ($user->can('planning.edit-own-task')) {
    ...
    public function delete(User $user, Task $task): bool
    {
        ...
        return $project &&
               $user->can('planning.delete-project-task') &&
               app(ProjectPolicy::class)->view($user, $project);
    }
    ...
    public function assign(User $user, Task $task): bool
    {
        ...
        return $project &&
               $user->can('planning.assign-project-task') &&
               app(ProjectPolicy::class)->view($user, $project);
    }
    ...
    {
        return $user->can('planning.complete-project-task') &&
               ($task->assigned_to === $user->id || $user->can('planning.edit-project-task'));
    }
    ...
    {
        return $user->can('planning.start-project-task') &&
               ($task->assigned_to === $user->id || $user->can('planning.edit-project-task'));
    }
    ...
    {
        return $user->can('planning.reorder-project-tasks') &&
               app(ProjectPolicy::class)->view($user, $project);
    }
}
