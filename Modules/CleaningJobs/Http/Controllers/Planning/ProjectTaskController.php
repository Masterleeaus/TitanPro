...
class ProjectTaskController extends Controller
{
    public function index(Request $request, Project $project)
    {
        ...
        return view('planning::projects.tasks.index', compact('project', 'statuses', 'priorities', 'users'));
    }
    ...
    public function board(Request $request, Project $project)
    {
        ...
        return view('planning::projects.tasks.board', compact('project', 'statuses', 'priorities', 'users'));
    }
    ...
    public function getDataAjax(Request $request, Project $project)
    {
        ...
        return datatables($tasks)
            ...
            ->addColumn('actions', function ($task) {
                return view('planning::projects.tasks._actions', compact('task'));
            })
    ...
    public function show(Project $project, Task $task)
    {
        ...
        if ($task->taskable_type !== 'Modules\CleaningJobs\Models\PlanningCore\Project' || $task->taskable_id != $project->id) {
