...
use Modules\CleaningJobs\Models\PlanningCore\ProjectStatus as ProjectStatusModel;
...
class ProjectStatusController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('planning::project-statuses.index', compact('statuses'));
    }
    ...
    public function show(ProjectStatusModel $projectStatus)
    {
        ...
        return view('planning::project-statuses.show', compact('projectStatus'));
    }
