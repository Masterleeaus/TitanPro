...
class ProjectReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('planning::reports.index', compact('stats'));
    }
    ...
    public function timeReport(Request $request)
    {
        ...
        return view('planning::reports.time', compact(
            'summary',
            'projectSummary',
            'projects',
            'users',
    ...
    public function budgetReport(Request $request)
    {
        ...
        return view('planning::reports.budget', compact('projects', 'summary', 'status', 'type'));
    }
    ...
    public function resourceReport(Request $request)
    {
        ...
        return view('planning::reports.resource', compact(
            'resources',
            'summary',
            'departments',
            'startDate',
