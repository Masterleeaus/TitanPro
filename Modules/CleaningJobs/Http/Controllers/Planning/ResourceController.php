...
use Modules\CleaningJobs\Models\PlanningCore\ResourceAllocation;
use Modules\CleaningJobs\Models\PlanningCore\ResourceCapacity;
...
class ResourceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('planning::resources.index', compact('stats', 'project'));
    }
    ...
    public function indexAjax(Request $request)
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('current_allocation', function ($user) {
                ...
                return view('planning::resources._allocation_summary', compact('allocations'))->render();
            })
                ...
                return view('components.datatable-actions', [
                    ...
                    'actions' => [
                        [
                            ...
                            'icon' => 'bx bx-calendar',
                            'url' => route('planning.resources.schedule', $user->id),
                        ],
                        [
                            'label' => __('Allocate'),
                            'icon' => 'bx bx-plus',
    ...
    public function schedule($userId)
    {
        ...
        return view('planning::resources.schedule', compact('user', 'allocations', 'capacities', 'startDate', 'endDate'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('planning::resources.create', compact('user', 'project'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (count($conflicts) > 0) {
                return redirect()->route('planning.resources.index')
    ...
    public function edit($id)
    {
        ...
        return view('planning::resources.edit', compact('allocation'));
    }
    ...
    public function capacity(Request $request)
    {
        ...
        return view('planning::resources.capacity', compact('capacityData', 'startDate', 'endDate', 'departments'));
    }
