...
use Modules\CleaningJobs\Enums\PlanningCore\TimesheetStatus;
...
class TimesheetController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('planning::timesheets.index');
    }
    ...
    public function indexAjax(Request $request)
    {
        ...
        if (! auth()->user()->can('planning.view-timesheets')) {
            ...
            ->addColumn('actions', function ($timesheet) {
                ...
                if ($timesheet->canBeEditedBy(Auth::user())) {
                    $actions[] = [
                        'label' => __('Edit'),
                        'icon' => 'bx bx-edit',
                        'url' => route('planning.timesheets.edit', $timesheet->id),
                    ];
                }

                // Only show submit for draft timesheets by the owner
                if ($timesheet->status === \Modules\CleaningJobs\Enums\PlanningCore\TimesheetStatus::DRAFT && $timesheet->user_id === Auth::id()) {
                    $actions[] = [
                        'label' => __('Submit'),
                        'icon' => 'bx bx-send',
                ...
                if ($timesheet->status === \Modules\CleaningJobs\Enums\PlanningCore\TimesheetStatus::DRAFT && $timesheet->canBeEditedBy(Auth::user())) {
                    $actions[] = [
                        'label' => __('Delete'),
                        'icon' => 'bx bx-trash',
    ...
    public function create()
    {
        ...
        return view('planning::timesheets.create', compact('projects', 'tasks'));
    }
    ...
    public function show($id)
    {
        ...
        return view('planning::timesheets.show', compact('timesheet'));
    }
    ...
    public function edit(Timesheet $timesheet)
    {
        ...
        return view('planning::timesheets.edit', compact('timesheet', 'projects', 'tasks'));
    }
