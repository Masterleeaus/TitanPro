...
namespace Modules\CleaningJobs\Http\Controllers\PlanningCore;
...
use Modules\CleaningJobs\Enums\PlanningCore\ProjectPriority;
use Modules\CleaningJobs\Enums\PlanningCore\ProjectStatus;
use Modules\CleaningJobs\Enums\PlanningCore\ProjectType;
use Modules\CleaningJobs\Models\PlanningCore\Project;
use Modules\CleaningJobs\Services\PlanningCore\PMIntegrationService;
...
class ProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('planning::projects.index', compact('stats', 'filters'));
    }
    ...
    public function getDataAjax(Request $request)
    {
        ...
        return datatables($query)
            ->addColumn('actions', function ($project) {
                return view('planning::projects._partials._actions', compact('project'))->render();
            })
    ...
    public function create()
    {
        ...
        return view('planning::projects.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($request, &$project) {
                ...
                $defaultStatus = $settingsService->get('PlanningCore', 'default_project_status', 'planning');
                $defaultPriority = $settingsService->get('PlanningCore', 'default_project_priority', 'medium');
                $defaultBillable = $settingsService->get('PlanningCore', 'default_is_billable', true);
            ...
            return redirect()->route('planning.projects.index')
    ...
    public function show(Project $project)
    {
        ...
        $stats = [
            ...
            'approved_hours' => $project->timesheets()->where('status', \Modules\CleaningJobs\Enums\PlanningCore\TimesheetStatus::APPROVED)->sum('hours'),
        ...
        return view('planning::projects.show', compact('project', 'stats', 'filters', 'recent_timesheets'));
    }
    ...
    public function edit(Project $project)
    {
        ...
        return view('planning::projects.edit', compact('project'));
    }
    ...
    public function update(Request $request, Project $project)
    {
        ...
        try {
            ...
            return redirect()->route('planning.projects.show', $project)
    ...
    protected function getProjectTaskCount($project): int
    {
        try {
            if (class_exists('\\Modules\\CRMCore\\app\\Models\\Task')) {
                return \Modules\CRMCore\app\Models\Task::where('taskable_type', 'Modules\CleaningJobs\Models\PlanningCore\Project')
    ...
    public function duplicate(Project $project)
    {
        try {
            ...
            return \App\ApiClasses\Success::response([
                ...
                'project' => $newProject,
                'redirect' => route('planning.projects.show', $newProject->id),
            ]);
    ...
    public function timesheets(Project $project)
    {
        ...
        $stats = [
            ...
            'pending_hours' => $project->timesheets()->whereIn('status', [
                \Modules\CleaningJobs\Enums\PlanningCore\TimesheetStatus::DRAFT,
                \Modules\CleaningJobs\Enums\PlanningCore\TimesheetStatus::SUBMITTED,
            ])->sum('hours'),
            'users_count' => $project->timesheets()->distinct('user_id')->count('user_id'),
        ];

        return view('planning::projects.timesheets', compact('project', 'stats'));
    }
}
