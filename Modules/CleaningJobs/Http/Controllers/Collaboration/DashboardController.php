...
class DashboardController extends Controller
{
    ...
    {
        if(Auth::user()->isAbleTo('jobboard dashboard manage'))
        {
            ...
            if(Auth::user()->hasRole('client'))
            {
                ...
                else
                {
                    ...
                    return view('jobboard::index', compact('currentWorkspace', 'totalProject', 'totalBugs', 'totalTask', 'totalMembers', 'arrProcessLabel', 'arrProcessPer', 'arrProcessClass', 'completeTask', 'tasks', 'chartData','totaltasks'));
