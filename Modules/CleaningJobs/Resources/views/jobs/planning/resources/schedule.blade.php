...
@section('page-script')
    <script>
        window.pageData = {
            ...
            urls: {
                updateAllocation: @json(route('planning.resources.update', ':id')),
                deleteAllocation: @json(route('planning.resources.destroy', ':id')),
                createAllocation: @json(route('planning.resources.store')),
                projectSearch: @json(route('planning.projects.search'))
            }
        };
    </script>
    @vite(['Modules/PlanningCore/resources/assets/js/resource-schedule.js'])
@endsection
                            ...
                            <div class="list-group-item px-0">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <a href="{{ route('planning.projects.show', $allocation->project_id) }}">
