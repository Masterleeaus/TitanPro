...
@section('page-script')
    <script>
        window.pageData = {
            ...
            urls: {
                capacityData: @json(route('planning.resources.capacity.data')),
                capacity: @json(route('planning.resources.capacity'))
            },
            labels: {
    ...
    @vite(['Modules/PlanningCore/resources/assets/js/capacity-planning.js'])
@endsection
...
<x-breadcrumb
    ...
    :breadcrumbs="[
        ...
        ['name' => __('Resources'), 'url' => route('planning.resources.index')],
...
<div class="card mb-4">
    <div class="card-body">
        <form id="capacityFilterForm" method="GET" action="{{ route('planning.resources.capacity') }}">
            <div class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <div>
                        ...
                        <a href="{{ route('planning.resources.capacity') }}" class="btn btn-label-secondary">
                            {{ __('Reset') }}
                        </a>
                    </div>
                </div>
                ...
                <tbody>
                    @foreach($capacityData['resource_breakdown'] as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('planning.resources.schedule', $item['resource']->id) }}" class="btn btn-sm btn-icon btn-text-secondary">
                                    <i class="bx bx-calendar"></i>
                                </a>
                                <a href="{{ route('planning.resources.create', ['user_id' => $item['resource']->id]) }}" class="btn btn-sm btn-icon btn-text-secondary">
