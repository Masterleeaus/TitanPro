...
@section('page-script')
    <script>
        window.pageData = {
            urls: {
                datatable: @json(route('planning.resources.data')),
                create: @json(route('planning.resources.create')),
                schedule: @json(route('planning.resources.schedule', ':id')),
    ...
    @vite(['Modules/PlanningCore/resources/assets/js/resources-list.js'])
@endsection
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('planning.resources.capacity') }}" class="btn btn-outline-primary">
                            <i class="bx bx-pie-chart-alt-2 me-1"></i>{{ __('Capacity Planning') }}
                        </a>
                        <a href="{{ route('planning.resources.create') }}" class="btn btn-primary">
