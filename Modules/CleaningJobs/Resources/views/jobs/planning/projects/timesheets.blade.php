...
@section('page-script')
    <script>
        window.pageData = {
            urls: {
                datatable: @json(route('planning.timesheets.data')),
                create: @json(route('planning.timesheets.create')),
                approve: @json(route('planning.timesheets.approve', ':id')),
                reject: @json(route('planning.timesheets.reject', ':id')),
                submit: @json(route('planning.timesheets.submit', ':id'))
            },
            labels: {
    ...
    @vite(['Modules/PlanningCore/resources/assets/js/project-timesheets.js'])
@endsection
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('planning.projects.show', $project->id) }}" class="btn btn-label-primary">
                            <i class="bx bx-arrow-back me-1"></i>{{ __('Back to Project') }}
                        </a>
                        @can('create', \Modules\PlanningCore\app\Models\Timesheet::class)
                            <a href="{{ route('planning.timesheets.create', ['project_id' => $project->id]) }}" class="btn btn-primary">
