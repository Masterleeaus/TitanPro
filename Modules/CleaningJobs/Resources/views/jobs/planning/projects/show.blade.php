...
@section('page-script')
    @vite(['Modules/PlanningCore/resources/assets/js/project-show.js'])
@endsection
...
<x-breadcrumb
    ...
    :breadcrumbs="[
        ...
        ['name' => __('Projects'), 'url' => route('planning.projects.index')],
    ...
    <div class="col-md-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex gap-2">
                <a href="{{ route('planning.projects.tasks.index', $project->id) }}" class="btn btn-outline-primary">
                    <i class="bx bx-task me-1"></i>{{ __('View Tasks') }}
                </a>
                <a href="{{ route('planning.projects.timesheets', $project->id) }}" class="btn btn-outline-primary">
                    <i class="bx bx-time-five me-1"></i>{{ __('View Timesheets') }}
                </a>
                <a href="{{ route('planning.resources.index', ['project_id' => $project->id]) }}" class="btn btn-outline-primary">
                    <i class="bx bx-user-pin me-1"></i>{{ __('View Resources') }}
                </a>
                <a href="{{ route('planning.projects.edit', $project->id) }}" class="btn btn-primary">
    ...
    <div class="col-md-4">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('planning.resources.create', ['project_id' => $project->id]) }}" class="btn btn-sm btn-outline-primary">
            ...
            <div class="card-body">
                    ...
                    @foreach($project->resourceAllocations as $allocation)
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('planning.resources.schedule', $allocation->user_id) }}">
                                            <i class="bx bx-calendar me-1"></i>{{ __('View Schedule') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('planning.resources.edit', $allocation->id) }}">
                ...
                @else
                    <div class="text-center py-3">
                        ...
                        <a href="{{ route('planning.resources.create', ['project_id' => $project->id]) }}" class="btn btn-sm btn-primary mt-2">
    ...
    <div class="col-md-6">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('planning.projects.tasks.index', $project->id) }}" class="btn btn-sm btn-outline-primary">
                    {{ __('View All') }}
                </a>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-6">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('planning.projects.tasks.board', $project->id) }}" class="btn btn-sm btn-outline-primary">
                    {{ __('Board View') }}
                </a>
            </div>
            <div class="card-body">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('planning.timesheets.index', ['project_id' => $project->id]) }}" class="btn btn-sm btn-label-primary">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="member_role" name="role" required>
                                    @foreach(\Modules\PlanningCore\app\Enums\ProjectMemberRole::cases() as $role)
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="edit_project_status" name="status" required>
                                    @foreach(\Modules\PlanningCore\app\Enums\ProjectStatus::cases() as $status)
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="edit_project_type" name="type" required>
                                    @foreach(\Modules\PlanningCore\app\Enums\ProjectType::cases() as $type)
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="edit_project_priority" name="priority" required>
                                    @foreach(\Modules\PlanningCore\app\Enums\ProjectPriority::cases() as $priority)
...
const pageData = {
    ...
    stats: @json($stats),
    urls: {
        projectUpdate: @json(route('planning.projects.update', ['project' => $project->id])),
        projectDelete: @json(route('planning.projects.destroy', ['project' => $project->id])),
        projectDuplicate: @json(route('planning.projects.duplicate', ['project' => $project->id])),
        projectArchive: @json(route('planning.projects.archive', ['project' => $project->id])),
        addMember: @json(route('planning.projects.members.store', ['project' => $project->id])),
        getMemberDetails: @json(route('planning.projects.members.show', ['project' => $project->id, 'member' => '__MEMBER_ID__'])),
        removeMember: @json(route('planning.projects.members.destroy', ['project' => $project->id, 'member' => '__MEMBER_ID__'])),
        updateMemberRole: @json(route('planning.projects.members.update', ['project' => $project->id, 'member' => '__MEMBER_ID__'])),
        userSearch: @json(route('planning.users.search')),
        clientSearch: @json(route('planning.clients.search'))
    },
    labels: {
