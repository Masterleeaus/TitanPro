...
<div class="card">
  ...
  <div class="card-body">
    <div class="row mb-3">
      <div class="col-md-6">
        <a href="{{ route('planning.projects.tasks.board', $project->id) }}" class="btn btn-outline-primary">
...
window.pageData = {
    ...
    urls: {
        tasksData: @json(route('planning.projects.tasks.getDataAjax', $project->id)),
        ...
        tasksDestroy: @json(route('planning.projects.tasks.destroy', [$project->id, '__ID__'])),
        tasksComplete: @json(route('planning.projects.tasks.complete', [$project->id, '__ID__'])),
        tasksStart: @json(route('planning.projects.tasks.start', [$project->id, '__ID__'])),
        tasksStop: @json(route('planning.projects.tasks.stop', [$project->id, '__ID__'])),
        tasksShow: @json(route('planning.projects.tasks.show', [$project->id, '__ID__'])),
        boardView: @json(route('planning.projects.tasks.board', $project->id))
    },
    labels: {
...
if (typeof window !== 'undefined') {
    ...
    @vite(['Modules/PlanningCore/resources/assets/js/project-tasks.js'])
@endsection
