...
@vite(['Modules/PlanningCore/resources/assets/js/project-form.js'])
@endsection
...
<x-breadcrumb
    ...
    :breadcrumbs="[
        ...
        ['name' => $project->name, 'url' => route('planning.projects.show', $project)],
        ['name' => __('Edit'), 'url' => '']
    ]"
...
<div class="row">
    <div class="col-md-12">
        <form id="projectForm" action="{{ route('planning.projects.update', $project) }}" method="POST">
            @csrf
            @method('PUT')

            @include('planning::projects._partials._form')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('planning.projects.show', $project) }}" class="btn btn-label-secondary">
