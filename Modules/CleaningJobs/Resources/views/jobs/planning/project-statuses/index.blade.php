...
@section('page-script')
    <script>
        window.pageData = {
            urls: {
                datatableUrl: @json(route('planning.project-statuses.getDataAjax')),
                storeUrl: @json(route('planning.project-statuses.store')),
                updateUrl: @json(route('planning.project-statuses.update', ['projectStatus' => '__ID__'])),
                deleteUrl: @json(route('planning.project-statuses.destroy', ['projectStatus' => '__ID__'])),
                toggleActiveUrl: @json(route('planning.project-statuses.toggle-active', ['projectStatus' => '__ID__'])),
                sortOrderUrl: @json(route('planning.project-statuses.update-sort-order')),
                setDefaultUrl: @json(route('planning.project-statuses.set-default'))
            },
            labels: {
    ...
    @vite(['Modules/PlanningCore/resources/assets/js/project-statuses.js'])
@endsection
