...
<x-breadcrumb
    ...
    :breadcrumbs="[
        ...
        ['name' => __('Project Statuses'), 'url' => route('planning.project-statuses.index')],
                    ...
                    <div class="mt-3">
                        ...
                        @foreach($projectStatus->projects()->latest()->limit(5)->get() as $project)
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <a href="{{ route('planning.projects.show', $project) }}" class="btn btn-sm btn-outline-primary">
                                    {{ __('View') }}
                                </a>
                            </div>
                        @endforeach
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="{{ route('planning.project-statuses.index') }}" class="btn btn-outline-secondary">
...
function editStatus(id) {
    window.location.href = '{{ route("planning.project-statuses.index") }}#edit-' + id;
}
