...
@section('page-script')
    @vite(['Modules/PlanningCore/resources/assets/js/dashboard.js'])
@endsection
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('planning.projects.index') }}" class="btn btn-sm btn-outline-primary">{{ __('View All') }}</a>
            </div>
            <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('planning.projects.show', $project->id) }}" class="text-decoration-none">
                                            {{ $project->name }}
                                        </a>
                                    </td>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('planning.projects.index') }}?filter=overdue" class="btn btn-sm btn-outline-danger">{{ __('View All') }}</a>
            </div>
            <div class="card-body">
