...
<x-breadcrumb
    ...
    :breadcrumbs="[
        ...
        ['name' => __('Reports'), 'url' => route('planning.reports.index')],
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('planning.reports.budget') }}" class="row g-3">
            <div class="col-md-4">
                <label class="form-label">{{ __('Status') }}</label>
                <select class="form-select" id="status" name="status">
                    <option value="">{{ __('All Statuses') }}</option>
                    @foreach(\Modules\PlanningCore\app\Enums\ProjectStatus::cases() as $statusOption)
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" id="type" name="type">
                    ...
                    @foreach(\Modules\PlanningCore\app\Enums\ProjectType::cases() as $typeOption)
            ...
            <div class="col-md-4 d-flex align-items-end">
                ...
                <a href="{{ route('planning.reports.budget') }}" class="btn btn-outline-secondary">
            ...
            <tbody>
                @forelse($projects as $data)
                    <tr class="{{ $data['is_over_budget'] ? 'table-danger' : '' }}">
                        <td>
                            <a href="{{ route('planning.projects.show', $data['project']->id) }}">
                                {{ $data['project']->name }}
                            </a>
                        </td>
