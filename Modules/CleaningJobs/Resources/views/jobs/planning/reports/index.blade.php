    ...
    <div class="col-lg-4 mb-4">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('planning.reports.time') }}" class="btn btn-primary">
    ...
    <div class="col-lg-4 mb-4">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('planning.reports.budget') }}" class="btn btn-success">
                    <i class="bx bx-right-arrow-alt me-1"></i>{{ __('View Report') }}
                </a>
            </div>
        </div>
    ...
    <div class="col-lg-4 mb-4">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('planning.reports.resource') }}" class="btn btn-info">
                    <i class="bx bx-right-arrow-alt me-1"></i>{{ __('View Report') }}
                </a>
            </div>
        </div>
