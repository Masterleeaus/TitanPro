...
@section('page-script')
    <script>
        window.pageData = {
            urls: {
                datatableUrl: @json(route('planning.timesheets.data')),
                createUrl: @json(route('planning.timesheets.create')),
                editUrl: @json(route('planning.timesheets.edit', ['timesheet' => '__ID__'])),
                deleteUrl: @json(route('planning.timesheets.destroy', ['timesheet' => '__ID__'])),
                approveUrl: @json(route('planning.timesheets.approve', ['timesheet' => '__ID__'])),
                rejectUrl: @json(route('planning.timesheets.reject', ['timesheet' => '__ID__'])),
                submitUrl: @json(route('planning.timesheets.submit', ['timesheet' => '__ID__'])),
                statisticsUrl: @json(route('planning.timesheets.statistics')),
                projectTasksUrl: @json(route('planning.timesheets.project-tasks', ['project' => '__PROJECT_ID__'])),
                usersSearchUrl: @json(route('planning.users.search')),
                projectsSearchUrl: @json(route('planning.projects.search'))
            },
            labels: {
    ...
    @vite(['Modules/PlanningCore/resources/assets/js/timesheets.js'])
@endsection
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">{{ __('Timesheets') }}</h5>
            <a href="{{ route('planning.timesheets.create') }}" class="btn btn-primary">
