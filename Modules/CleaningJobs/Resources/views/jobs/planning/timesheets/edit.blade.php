...
@section('page-script')
    <script>
        window.pageData = {
            urls: {
                updateUrl: @json(route('planning.timesheets.update', ['timesheet' => $timesheet->id])),
                projectTasksUrl: @json(route('planning.timesheets.project-tasks', ['project' => '__PROJECT_ID__'])),
                indexUrl: @json(route('planning.timesheets.index')),
    ...
    @vite(['Modules/PlanningCore/resources/assets/js/timesheets-edit.js'])
@endsection
...
<x-breadcrumb
    ...
    :breadcrumbs="[
        ...
        ['name' => __('Timesheets'), 'url' => route('planning.timesheets.index')],
        ['name' => __('Edit'), 'url' => '']
    ]"
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            <div class="card-header">
                ...
                @if($timesheet->status !== \Modules\PlanningCore\app\Enums\TimesheetStatus::DRAFT)
                ...
                <form id="timesheetForm" method="POST">
                    ...
                    @if($timesheet->canBeEditedBy(auth()->user()))
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('planning.timesheets.index') }}" class="btn btn-label-secondary">
