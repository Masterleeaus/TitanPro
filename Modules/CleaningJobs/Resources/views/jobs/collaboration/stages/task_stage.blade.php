...
<div id="task-stages-settings" class="row">
    <div class="col-sm-3">
        @include('cleaningjobs::jobs.collaboration.layouts.system_setup')
    </div>
    <div class="col-md-9">
...
@push('scripts')
    <script src="{{ asset('modules/cleaningjobs/assets/collaboration/js/jquery-ui.min.js')}}"></script>
    <script src="{{ asset('modules/cleaningjobs/assets/collaboration/js/repeater.js')}}"></script>
    <script src="{{ asset('modules/cleaningjobs/assets/collaboration/js/colorPick.js')}}"></script>
