        ...
        <div class="modal-body">
            <div class="text-end">
                @if (module_is_active('AIAssistant'))
                    @include('aiassistant::ai.generate_ai_btn',['template_module' => 'project bug','module'=>'JobBoard'])
                @endif
            </div>
            <div class="row">
                ...
                <div class="form-group col-md-12 mb-0">
                    <label for="task-description" class="form-label">{{ __('Description')}}</label><x-required></x-required>
