@if($project && $currentWorkspace)
    <form class="needs-validation" method="post" action="{{ route('tasks.store',[$project->id]) }}" novalidate>
        ...
        <div class="modal-body">
            <div class="text-end">
                @if (module_is_active('AIAssistant'))
                    @include('aiassistant::ai.generate_ai_btn',['template_module' => 'project task','module'=>'JobBoard'])
                @endif
            </div>
            <div class="row">
     ...
     <link rel="stylesheet" href="{{ asset('packages/workdo/JobBoard/src/Resources/assets/libs/bootstrap-daterangepicker/daterangepicker.css')}} ">
     <script src="{{ asset('packages/workdo/JobBoard/src/Resources/assets/libs/moment/min/moment.min.js')}}"></script>
     <script src="{{ asset('packages/workdo/JobBoard/src/Resources/assets/libs/bootstrap-daterangepicker/daterangepicker.js')}}"></script>
