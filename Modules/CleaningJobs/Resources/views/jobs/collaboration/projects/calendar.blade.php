...
@endsection
@push('css')
    <link rel="stylesheet" href="{{ asset('packages/workdo/JobBoard/src/Resources/assets/css/main.css') }}">
@endpush
@section('content')
    <div class="row">
...
@endsection
@push('scripts')
    <script src="{{ asset('packages/workdo/JobBoard/src/Resources/assets/js/main.min.js') }}"></script>
