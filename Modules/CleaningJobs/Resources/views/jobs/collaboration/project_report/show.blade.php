                                    ...
                                    <tbody>
                                        @foreach ($project->users as $user)
                                            @php
                                                ...
                                                $total_user_task = Workdo\JobBoard\Entities\Task::where(
                                                    'project_id',
                                                    $project->id,
                                                )
                                                ...
                                                $all_task = Workdo\JobBoard\Entities\Task::where(
                                                    'project_id',
                                                    $project->id,
                                                )
                                                    ->whereRaw('FIND_IN_SET(?,  assign_to) > 0', [$user->id])
                                                ...
                                                $total_complete_task = Workdo\JobBoard\Entities\Task::join(
                                                    'stages',
                                                    'stages.id',
                                                    '=',
                                                    'tasks.status',
...
@push('css')
    <link rel="stylesheet" href="{{ asset('packages/workdo/JobBoard/src/Resources/assets/css/datatables.min.css') }}">
    <link rel="stylesheet" href="{{ asset('packages/workdo/JobBoard/src/Resources/assets/css/custom.css') }}">
    <style type="text/css">
...
@push('scripts')
    ...
    <script src="{{ asset('packages/workdo/JobBoard/src/Resources/assets/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('packages/workdo/JobBoard/src/Resources/assets/js/apexcharts.min.js') }}"></script>
