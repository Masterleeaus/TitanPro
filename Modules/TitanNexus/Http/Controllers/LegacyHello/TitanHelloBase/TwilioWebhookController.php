...
use Extensions\TitanNexus\Services\SettingsService;
use Extensions\TitanNexus\Models\TitanNexusCallSession;
use Extensions\TitanNexus\Models\TitanNexusCallEvent;
use Extensions\TitanNexus\Models\TitanNexusPhoneNumber;
use Extensions\TitanNexus\Services\LeadExtractionService;
use Extensions\TitanNexus\Services\CallSummaryService;
use Extensions\TitanNexus\Services\TwilioSmsService;
...
class TwilioWebhookController extends Controller
{
    public function inbound(Request $request, SettingsService $settings): Response
    {
        ...
        $phoneNumber = TitanNexusPhoneNumber::query()
        ...
        $session = TitanNexusCallSession::query()->firstOrCreate(
            ['call_sid' => $callSid],
            [
                'from_number' => $from,
                'to_number' => $to,
        ...
        if ($agent && !$session->conversation_db_id) {
            $conversation = \Extensions\TitanNexus\Models\ExtVoicechabotConversation::query()->create([
