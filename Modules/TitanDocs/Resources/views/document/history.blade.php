...
<div class="table-responsive">
                    <table class="table mb-0 pc-dt-simple" id="assets">
                        ...
                        <tbody>
                        @foreach (($document ?? collect()) as $temp)
                            <tr class="font-style">
                            ...
                            <td>
                                ...
                                <div class="action-btn bg-danger ms-2">
                                    <form method="POST" action="{{ route('aidocument.document.destroy', [$temp->id]) }}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="mx-3 btn btn-sm align-items-center text-white border-0 bg-transparent" data-bs-toggle="tooltip" title="{{ __('Delete') }}">
