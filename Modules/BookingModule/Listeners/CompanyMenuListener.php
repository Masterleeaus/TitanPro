...
{
    /**
     * Legacy menu hook retained for compatibility with apps that still dispatch
     * a company-menu style event. This module's primary sidebar integration now
     * lives in Resources/views/sections/sidebar.blade.php.
     */
    public function handle($event): void
    {
        if (!is_object($event) || !isset($event->menu) || !is_object($event->menu) || !method_exists($event->menu, 'add')) {
            return;
        }
