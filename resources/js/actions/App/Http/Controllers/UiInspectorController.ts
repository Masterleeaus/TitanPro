...
const UiInspectorController = { index, upsert, exportMethod, importMethod, reset, resetAll, export: exportMethod, import: importMethod }

export default UiInspectorController