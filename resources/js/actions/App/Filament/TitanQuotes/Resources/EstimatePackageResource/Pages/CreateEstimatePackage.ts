...
/**
* @see \App\Filament\TitanQuotes\Resources\EstimatePackageResource\Pages\CreateEstimatePackage::__invoke
* @see app/Filament/TitanQuotes/Resources/EstimatePackageResource/Pages/CreateEstimatePackage.php:7
* @route '/titanquotes/estimate-packages/create'
*/
...
CreateEstimatePackage.definition = {
    methods: ["get","head"],
    url: '/titanquotes/estimate-packages/create',
