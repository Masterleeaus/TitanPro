...
/**
* @see \App\Filament\TitanPro\Resources\UserResource\Pages\EditUser::__invoke
* @see app/Filament/TitanPro/Resources/UserResource/Pages/EditUser.php:7
* @route '/titanpro/users/{record}/edit'
*/
...
EditUser.definition = {
    methods: ["get","head"],
    url: '/titanpro/users/{record}/edit',
