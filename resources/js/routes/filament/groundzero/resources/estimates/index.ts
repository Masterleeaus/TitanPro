...
/**
* @see \App\Filament\GroundZero\Resources\EstimateResource\Pages\CreateEstimate::__invoke
* @see app/Filament/GroundZero/Resources/EstimateResource/Pages/CreateEstimate.php:7
* @route '/groundzero/estimates/create'
*/
...
create.definition = {
    methods: ["get","head"],
    url: '/groundzero/estimates/create',
} satisfies RouteDefinition<["get","head"]>
