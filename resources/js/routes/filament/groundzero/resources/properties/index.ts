...
/**
* @see \App\Filament\GroundZero\Resources\PropertyResource\Pages\CreateProperty::__invoke
* @see app/Filament/GroundZero/Resources/PropertyResource/Pages/CreateProperty.php:7
* @route '/groundzero/properties/create'
*/
...
create.definition = {
    methods: ["get","head"],
    url: '/groundzero/properties/create',
} satisfies RouteDefinition<["get","head"]>
