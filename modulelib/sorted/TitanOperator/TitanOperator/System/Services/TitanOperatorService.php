                ...
                $query->orderBy(
                    function ($query) {
                        $query->select('created_at')
                            ->from('ext_titan_operator_histories')
                            ->whereColumn('ext_titan_operator_histories.conversation_id', 'ext_titan_operator_conversations.id')
                            ->where('ext_titan_operator_histories.role', 'user')
                            ->latest()
                            ->limit(1);
                    },
                    'desc'
