                ...
                <div class="relative overflow-hidden rounded-2xl bg-indigo-600 px-6 py-10 shadow-xl sm:px-12 sm:py-20">
                    ...
                    <div class="relative">
                        <div class="sm:text-center">
                            ...
                            <p class="mx-auto mt-6 max-w-2xl text-lg text-indigo-200">Apakah Anda tertarik untuk meningkatkan interaksi pelanggan Anda dengan titan_operator AI? Anda dapat mendaftar untuk mendapatkan notifikasi saat kami rilis.</p>
                        </div>
