...
namespace App\Extensions\TitanOperator\System\Voice\Parsers;
...
class LinkParser
{
    ...
    public function insertEmbeddings(ExtVoiceTitanOperator $titan_operator): void
    {
        foreach ($this->contents as $url => $data) {
            ExtVoiceoperatorTrain::query()
                ->firstOrCreate([
