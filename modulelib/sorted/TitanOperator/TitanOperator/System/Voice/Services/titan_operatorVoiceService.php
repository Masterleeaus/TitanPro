...
namespace App\Extensions\TitanOperator\System\Voice\Services;
...
class ChabotVoiceService
{
    ...
    /**
     * return query for ExtVoiceTitanOperator
     */
    public function query(): Builder
    {
        return ExtVoiceTitanOperator::query();
    }
    ...
    {
        return ExtVoiceoperatorAvatar::query()
    ...
    {
        $agent = ExtVoiceTitanOperator::find($agent_id);
        if (empty($agent)) {
            return;
        }
     ...
     */
    public function updateAgentWithKnowledgebase(string|int $operator_id): void
    {
        ...
        $agent_id = ExtVoiceTitanOperator::findOrFail($operator_id)?->agent_id;
