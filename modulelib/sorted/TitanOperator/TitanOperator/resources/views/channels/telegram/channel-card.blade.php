@php
	$image = 'vendor/titan-operator-multi-channel/icons/telegram.svg';
	$image_dark_version = 'vendor/titan-operator-multi-channel/icons/telegram-light.svg';
...
>
	...
	<x-slot:modal>
		...
		<form id="storeForm-telegram" class="" action="{{ route('dashboard.titan_operator_multi_channel.telegram.store') }}">
