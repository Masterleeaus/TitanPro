@php
	$image = 'vendor/titan-operator-multi-channel/icons/whatsapp.svg';
	$image_dark_version = 'vendor/titan-operator-multi-channel/icons/whatsapp-light.svg';
...
>
	...
	<x-slot:modal>
		...
		<form id="storeForm-whatsapp" class="" action="{{ route('dashboard.titan_operator_multi_channel.whatsapp.store') }}">
