@php
    $connect_agent_enabled =
        ...
        \App\Helpers\Classes\MarketplaceHelper::isRegistered('titan_operator_agent');
@endphp
...
<template x-for="(message, index) in messages">
    <div>
        ...
        <template x-if="message.role !== 'connecting-to-agent'">
            <div
                class="lqd-ext-titan_operator-window-conversation-message"
                :data-type="message.role"
                :data-id="message.id"
            >
                <figure
                    class="lqd-ext-titan_operator-window-conversation-message-avatar"
                ...
                <div class="lqd-ext-titan_operator-window-conversation-message-content-wrap">
                    <div class="lqd-ext-titan_operator-window-conversation-message-content text-xs/5">
                        <pre
                            class="peer"
                        ...
                        <template x-if="message.role === 'loader'">
                            <span class="lqd-ext-titan_operator-window-conversation-message-loader inline-flex items-center gap-1">
                    ...
                    @if (isset($titan_operator) && $titan_operator['show_date_and_time'])
                        <div
                            class="lqd-ext-titan_operator-window-conversation-message-time"
                ...
                >
                    ...
                    <span class="flex items-center gap-1">
                        ...
                        <template x-if="message.role === 'connect-agent' && connectingToAgent">
                            <span class="lqd-ext-titan_operator-window-conversation-message-loader inline-flex items-center gap-0.5">
