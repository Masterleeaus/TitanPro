<form
    class="lqd-ext-titan_operator-window-form relative min-h-full w-full"
...
>
    ...
    @if ($is_editor || (isset($titan_operator) && $titan_operator->is_emoji))
        <div
            class="lqd-ext-titan_operator-emoji-picker pointer-events-auto absolute -inset-x-4 bottom-full"
            x-ref="emojiPicker"
