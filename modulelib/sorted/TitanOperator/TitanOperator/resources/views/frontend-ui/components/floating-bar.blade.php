<div
    class="lqd-ext-titan_operator-floating-bar absolute inset-x-[18px] bottom-14 z-10 grid rounded-full border px-3 py-1 shadow-2xl backdrop-blur-md transition-all before:pointer-events-none before:absolute before:-inset-px before:rounded-[inherit] before:border before:border-black/5 before:opacity-0 before:transition-opacity before:[mask-image:linear-gradient(to_bottom,black,transparent)] sm:px-4"
