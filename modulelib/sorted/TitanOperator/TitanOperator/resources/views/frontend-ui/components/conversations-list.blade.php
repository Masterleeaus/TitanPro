<div class="w-full">
    ...
    >
        ...
        <h4 class="lqd-ext-titan_operator-window-conversations-list-no-conversations mb-0 text-sm font-semibold">
    ...
    <template @if (!isset($take)) x-for="conversation in conversations"@else x-for="conversation in conversations.slice(0, {{ $take }})" @endif>
        <div
            class="lqd-ext-titan_operator-window-conversations-list-item group relative flex gap-4 border-b py-4 transition-colors hover:border-transparent"
            :data-id="conversation.id"
            :key="conversation.id"
        >
            <figure class="lqd-ext-titan_operator-window-conversations-list-item-fig relative z-1 shrink-0 place-self-center">
                <img
            ...
            <div class="lqd-ext-titan_operator-window-conversations-list-item-info relative z-1 text-2xs">
                <p
                    class="lqd-ext-titan_operator-window-conversations-list-item-info-name m-0 text-black"
                    x-text="activeTitanOperator.title"
                ></p>
                <p
                    class="lqd-ext-titan_operator-window-conversations-list-item-info-last-message m-0 line-clamp-1 w-full overflow-hidden text-ellipsis opacity-70"
                    x-text="conversation.last_message"
                ></p>
            </div>
            <div
                class="lqd-ext-titan_operator-window-conversations-list-item-time relative z-1 ms-auto whitespace-nowrap text-[12px]"
