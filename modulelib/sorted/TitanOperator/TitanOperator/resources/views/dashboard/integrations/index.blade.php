...
<div class="container-fluid">
  <div class="d-flex align-items-center justify-content-between mb-3">
    <div>
      ...
      <div class="text-muted">Titan Operator: <strong>{{ $titan_operator->name ?? ('#'.$titan_operator->id) }}</strong></div>
    </div>
    <div>
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          @if(empty($channelRows))
            <div class="text-muted">No channels connected for this titan_operator yet.</div>
          @else
          ...
          <div class="alert alert-info mt-3 mb-0">
            <strong>Note:</strong> Channel connection details are managed via the channel-specific cards in the titan_operator UI (WhatsApp/Telegram/Messenger).
