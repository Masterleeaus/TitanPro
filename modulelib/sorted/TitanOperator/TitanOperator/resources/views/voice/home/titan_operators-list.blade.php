...
<div class="py-14">
    <h2 class="mb-9">
        @lang('Active Voice TitanOperators')
    </h2>
                    ...
                    >
                        ...
                        >
                            @php
                                $dropdown_items = [
                                    [
                                        ...
                                        'link' => '#',
                                        'attrs' => [
                                            '@click.prevent' => 'setActiveTitanOperator(titan_operator.id, 1, true);',
                                        ],
                                    ],
                                    [
                                        'label' => __('Customize'),
                                        'link' => '#',
                                        'attrs' => [
                                            '@click.prevent' => 'setActiveTitanOperator(titan_operator.id, 2, true);',
                                        ],
                                    ],
                                    [
                                        'label' => __('Train'),
                                        'link' => '#',
                                        'attrs' => [
                                            '@click.prevent' => 'setActiveTitanOperator(titan_operator.id, 3);',
                                        ],
                                    ],
                                    [
                                        'label' => __('Embed'),
                                        'link' => '#',
                                        'attrs' => [
                                            '@click.prevent' => 'setActiveTitanOperator(titan_operator.id, 4, true);',
                                        ],
                                    ],
                                ];
                            ...
                            <ul class="py-1 text-xs font-medium">
                                ...
                                <li :class="{ 'opacity-50': submittingData, 'pointer-events-none': submittingData }">
                                    <form
                                        action="{{ route('dashboard.titan_operator-voice.delete') }}"
