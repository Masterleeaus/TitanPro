...
>
    ...
    <div class="lqd-ext-titan_operator-training mt-16 flex flex-col justify-center gap-9">
        ...
        <div class="lqd-ext-titan_operator-training-content grid">
            @include('titan_operator-voice::home.training.training-tabs.training-tab-website')
            @include('titan_operator-voice::home.training.training-tabs.training-tab-pdf')
            @include('titan_operator-voice::home.training.training-tabs.training-tab-text')
        </div>
    </div>
                ...
                Alpine.data('externalTitanOperatorTraining', () => ({
                    ...
                    async fetchEmbeddings() {
                        ...
                        const res = await fetch(
                            `{{ route('dashboard.titan_operator-voice.train.data') }}?id=${this.activeTitanOperator.id}`
                        );
                    ...
                    async deleteEmbedding(embeddingId) {
                        ...
                        const res = await fetch(
                            '{{ route('dashboard.titan_operator-voice.train.delete') }}', {
                                method: 'DELETE',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'Accept': 'application/json',
