...
>
    ...
    <p class="mb-14 text-xs/5 opacity-60 lg:max-w-[360px]">
        @lang('Your external AI titan_operator has been successfully created! You can now integrate it into your website and start engaging with your audience.')
    </p>
    ...
    <div class="mb-14">
        ...
        >
            &lt;script
            defer
            src="{{ url('vendor/titan-operator-voice/js/external-titan_operator-voice.js') }}"
    ...
    <div>
        ...
        <p class="mb-3 text-xs/5 opacity-60 lg:max-w-[360px]">
            @lang('Paste this code just before the closing &lt;/body&gt; tag in your HTML file, then save the changes. Refresh your site to ensure your titan_operator works correctly.')
        </p>
    </div>
</div>
