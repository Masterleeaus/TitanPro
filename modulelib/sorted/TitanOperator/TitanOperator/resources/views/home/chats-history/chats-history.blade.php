...
@endphp
<div
    class="lqd-ext-titan_operator-history invisible fixed end-0 start-0 top-0 z-10 flex h-screen bg-background opacity-0 transition-all max-sm:block lg:start-[--navbar-width] lg:group-[&.focus-mode]/body:start-0 [&.lqd-open]:visible [&.lqd-open]:opacity-100"
...
>
    ...
    >
        ...
        <div
            class="lqd-ext-titan_operator-history-messages relative flex h-full flex-col gap-2 py-10"
