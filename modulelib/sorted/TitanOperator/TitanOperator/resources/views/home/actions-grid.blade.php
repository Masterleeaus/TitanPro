        ...
        <div class="flex flex-col gap-y-4 md:flex-row">
			...
			@if(\App\Helpers\Classes\MarketplaceHelper::isRegistered('titan_operator_agent'))
				<a
					...
					href="{{ route('dashboard.titan_operator_agent.index') }}"
				>
...
<div class="grid grid-cols-1 gap-5 lg:grid-cols-2 lg:gap-11">
    ...
    >
        <figure class="mx-auto mb-6 inline-grid size-40 place-items-center rounded-full bg-heading-foreground/[3%]">
            <img
                src="{{ asset('vendor/titan-operator/images/titan_operator-create.png') }}"
                alt="Add New Titan Operator"
            >
        </figure>
        ...
        <x-button
            @click.prevent="setActiveTitanOperator('new_operator', 1, true);"
            variant="ghost-shadow"
            href="#"
        >
            <x-tabler-plus class="size-4" />
            @lang('Add New Titan Operator')
        </x-button>
    </x-card>
    ...
    >
        <figure class="mx-auto mb-6 inline-grid size-40 place-items-center rounded-full bg-heading-foreground/[3%]">
            <img
                src="{{ asset('vendor/titan-operator/images/titan_operator-history.png') }}"
