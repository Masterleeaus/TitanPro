@php
    ...
    $activeHub = 'work';
    $hubManifest = file_exists(base_path('dashboard_support/work/manifest.php'))
        ? include base_path('dashboard_support/work/manifest.php')
        : [];
    $hubKpis = file_exists(base_path('dashboard_support/work/kpis.php'))
        ? include base_path('dashboard_support/work/kpis.php')
        : [];
    $hubActions = file_exists(base_path('dashboard_support/work/actions.php'))
        ? include base_path('dashboard_support/work/actions.php')
        : [];
    $hubTabs = file_exists(base_path('dashboard_support/work/tabs.php'))
        ? include base_path('dashboard_support/work/tabs.php')
        : [];
    $hubAssistants = file_exists(base_path('dashboard_support/work/assistants.php'))
        ? include base_path('dashboard_support/work/assistants.php')
        : [];
    $hubLifecycles = file_exists(base_path('dashboard_support/work/lifecycles.php'))
        ? include base_path('dashboard_support/work/lifecycles.php')
        : [];

    $hubTitle = $hubManifest['title'] ?? 'Work Hub';
    $hubPurpose = $hubManifest['purpose'] ?? 'Jobs, tasks, routing, proof, quality control, dispatch, and operational execution.';
