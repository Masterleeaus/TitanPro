@php
    ...
    $activeHub = 'trust_vault';
    $hubManifest = file_exists(base_path('dashboard_support/trust_vault/manifest.php'))
        ? include base_path('dashboard_support/trust_vault/manifest.php')
        : [];
    $hubKpis = file_exists(base_path('dashboard_support/trust_vault/kpis.php'))
        ? include base_path('dashboard_support/trust_vault/kpis.php')
        : [];
    $hubActions = file_exists(base_path('dashboard_support/trust_vault/actions.php'))
        ? include base_path('dashboard_support/trust_vault/actions.php')
        : [];
    $hubTabs = file_exists(base_path('dashboard_support/trust_vault/tabs.php'))
        ? include base_path('dashboard_support/trust_vault/tabs.php')
        : [];
    $hubAssistants = file_exists(base_path('dashboard_support/trust_vault/assistants.php'))
        ? include base_path('dashboard_support/trust_vault/assistants.php')
        : [];
    $hubLifecycles = file_exists(base_path('dashboard_support/trust_vault/lifecycles.php'))
        ? include base_path('dashboard_support/trust_vault/lifecycles.php')
        : [];

    $hubTitle = $hubManifest['title'] ?? 'Trust Vault';
    $hubPurpose = $hubManifest['purpose'] ?? 'Contracts, documents, proof, compliance, audit trails, and verified financial records.';
