@php
    ...
    $activeHub = 'money';
    $hubManifest = file_exists(base_path('dashboard_support/money/manifest.php'))
        ? include base_path('dashboard_support/money/manifest.php')
        : [];
    $hubKpis = file_exists(base_path('dashboard_support/money/kpis.php'))
        ? include base_path('dashboard_support/money/kpis.php')
        : [];
    $hubActions = file_exists(base_path('dashboard_support/money/actions.php'))
        ? include base_path('dashboard_support/money/actions.php')
        : [];
    $hubTabs = file_exists(base_path('dashboard_support/money/tabs.php'))
        ? include base_path('dashboard_support/money/tabs.php')
        : [];
    $hubAssistants = file_exists(base_path('dashboard_support/money/assistants.php'))
        ? include base_path('dashboard_support/money/assistants.php')
        : [];
    $hubLifecycles = file_exists(base_path('dashboard_support/money/lifecycles.php'))
        ? include base_path('dashboard_support/money/lifecycles.php')
        : [];

    $hubTitle = $hubManifest['title'] ?? 'Money Manager';
    $hubPurpose = $hubManifest['purpose'] ?? 'Payments, cashflow, overdue recovery, expenses, margin, and financial processing.';
