@php
    ...
    $activeHub = 'team';
    $hubManifest = file_exists(base_path('dashboard_support/team/manifest.php'))
        ? include base_path('dashboard_support/team/manifest.php')
        : [];
    $hubKpis = file_exists(base_path('dashboard_support/team/kpis.php'))
        ? include base_path('dashboard_support/team/kpis.php')
        : [];
    $hubActions = file_exists(base_path('dashboard_support/team/actions.php'))
        ? include base_path('dashboard_support/team/actions.php')
        : [];
    $hubTabs = file_exists(base_path('dashboard_support/team/tabs.php'))
        ? include base_path('dashboard_support/team/tabs.php')
        : [];
    $hubAssistants = file_exists(base_path('dashboard_support/team/assistants.php'))
        ? include base_path('dashboard_support/team/assistants.php')
        : [];
    $hubLifecycles = file_exists(base_path('dashboard_support/team/lifecycles.php'))
        ? include base_path('dashboard_support/team/lifecycles.php')
        : [];

    $hubTitle = $hubManifest['title'] ?? 'Team Portal';
    $hubPurpose = $hubManifest['purpose'] ?? 'People, crews, availability, skills, performance, and team coordination.';
