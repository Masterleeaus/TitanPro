@php
    ...
    $activeHub = 'home';
    $hubManifest = file_exists(base_path('dashboard_support/home/manifest.php'))
        ? include base_path('dashboard_support/home/manifest.php')
        : [];
    $hubKpis = file_exists(base_path('dashboard_support/home/kpis.php'))
        ? include base_path('dashboard_support/home/kpis.php')
        : [];
    $hubActions = file_exists(base_path('dashboard_support/home/actions.php'))
        ? include base_path('dashboard_support/home/actions.php')
        : [];
    $hubTabs = file_exists(base_path('dashboard_support/home/tabs.php'))
        ? include base_path('dashboard_support/home/tabs.php')
        : [];
    $hubAssistants = file_exists(base_path('dashboard_support/home/assistants.php'))
        ? include base_path('dashboard_support/home/assistants.php')
        : [];
    $hubLifecycles = file_exists(base_path('dashboard_support/home/lifecycles.php'))
        ? include base_path('dashboard_support/home/lifecycles.php')
        : [];

    $hubTitle = $hubManifest['title'] ?? 'Command Centre';
    $hubPurpose = $hubManifest['purpose'] ?? 'Cross-hub signals, AI guidance, alerts, opportunities, and business-wide command visibility.';
