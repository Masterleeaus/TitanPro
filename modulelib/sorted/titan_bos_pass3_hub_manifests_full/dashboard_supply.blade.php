@php
    ...
    $activeHub = 'supply';
    $hubManifest = file_exists(base_path('dashboard_support/supply/manifest.php'))
        ? include base_path('dashboard_support/supply/manifest.php')
        : [];
    $hubKpis = file_exists(base_path('dashboard_support/supply/kpis.php'))
        ? include base_path('dashboard_support/supply/kpis.php')
        : [];
    $hubActions = file_exists(base_path('dashboard_support/supply/actions.php'))
        ? include base_path('dashboard_support/supply/actions.php')
        : [];
    $hubTabs = file_exists(base_path('dashboard_support/supply/tabs.php'))
        ? include base_path('dashboard_support/supply/tabs.php')
        : [];
    $hubAssistants = file_exists(base_path('dashboard_support/supply/assistants.php'))
        ? include base_path('dashboard_support/supply/assistants.php')
        : [];
    $hubLifecycles = file_exists(base_path('dashboard_support/supply/lifecycles.php'))
        ? include base_path('dashboard_support/supply/lifecycles.php')
        : [];

    $hubTitle = $hubManifest['title'] ?? 'Supply Depot';
    $hubPurpose = $hubManifest['purpose'] ?? 'Assets, inventory, suppliers, purchases, maintenance, and stock control.';
