                ...
                Route::prefix('openai')->name('openai.')
                    ->group(function () {
                        ...
                        Route::prefix('documents')->name('documents.')->group(function () {
                            ...
                            Route::get('/review', [UserController::class, 'documentsReview'])->name('review');
                            Route::get('/packets', [UserController::class, 'documentsPackets'])->name('packets');
                            Route::get('/single/{slug}/proof-export', [UserController::class, 'documentProofExport'])->name('proof.export');
