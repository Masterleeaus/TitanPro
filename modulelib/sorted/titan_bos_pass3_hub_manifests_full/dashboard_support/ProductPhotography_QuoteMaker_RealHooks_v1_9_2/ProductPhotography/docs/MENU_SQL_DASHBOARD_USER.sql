...
SELECT '1.8.7','productphotography',1,NOW(),NOW(),0
WHERE NOT EXISTS (SELECT 1 FROM `extensions` WHERE `slug`='productphotography');

UPDATE `extensions`
SET `version`='1.8.7', `installed`=1, `updated_at`=NOW(), `is_theme`=0
...
UPDATE `menus`
SET `route`='dashboard.user.quotemaker.index',`label`='QuoteMaker',`icon`='tabler-file-invoice',`params`='[]',`type`='item',`extension`='1',`bolt_menu`=0,`is_active`=1,`updated_at`=NOW()
...
UPDATE `menus`
SET `route`='dashboard.user.quotemaker.builder',`label`='Quote Builder',`icon`='tabler-sparkles',`params`='[]',`type`='item',`extension`='1',`bolt_menu`=0,`is_active`=1,`updated_at`=NOW()
...
UPDATE `menus`
SET `route`='dashboard.user.quotemaker.templates',`label`='Templates',`icon`='tabler-layout-grid',`params`='[]',`type`='item',`extension`='1',`bolt_menu`=0,`is_active`=1,`updated_at`=NOW()
...
UPDATE `menus`
SET `route`='dashboard.user.quotemaker.gallery',`label`='Drafts',`icon`='tabler-photo',`params`='[]',`type`='item',`extension`='1',`bolt_menu`=0,`is_active`=1,`updated_at`=NOW()
