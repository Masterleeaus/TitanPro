@php
    ...
    $activeHub = 'connect';
    $hubManifest = file_exists(base_path('dashboard_support/connect/manifest.php'))
        ? include base_path('dashboard_support/connect/manifest.php')
        : [];
    $hubKpis = file_exists(base_path('dashboard_support/connect/kpis.php'))
        ? include base_path('dashboard_support/connect/kpis.php')
        : [];
    $hubActions = file_exists(base_path('dashboard_support/connect/actions.php'))
        ? include base_path('dashboard_support/connect/actions.php')
        : [];
    $hubTabs = file_exists(base_path('dashboard_support/connect/tabs.php'))
        ? include base_path('dashboard_support/connect/tabs.php')
        : [];
    $hubAssistants = file_exists(base_path('dashboard_support/connect/assistants.php'))
        ? include base_path('dashboard_support/connect/assistants.php')
        : [];
    $hubLifecycles = file_exists(base_path('dashboard_support/connect/lifecycles.php'))
        ? include base_path('dashboard_support/connect/lifecycles.php')
        : [];

    $hubTitle = $hubManifest['title'] ?? 'Connect Core';
    $hubPurpose = $hubManifest['purpose'] ?? 'Leads, customers, pipeline, campaigns, comms, and lifecycle growth orchestration.';
