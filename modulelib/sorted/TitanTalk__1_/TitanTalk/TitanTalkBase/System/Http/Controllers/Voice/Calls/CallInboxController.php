...
class CallInboxController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('marketing-bot::voice.calls.index', compact('calls', 'filter'));
    }

    public function show($id)
    {
        $call = Call::query()->with(['events', 'recordings', 'notes'])->findOrFail($id);
        return view('marketing-bot::voice.calls.show', compact('call'));
    }
    ...
    public function assign(Request $request, $id)
    {
        ...
        return redirect()->route('dashboard.user.marketing-bot.voice.calls.show', ['id' => $call->id])->with('success', 'Assignment updated.');
    }
    ...
    public function disposition(Request $request, $id)
    {
        ...
        return redirect()->route('dashboard.user.marketing-bot.voice.calls.show', ['id' => $call->id])->with('success', 'Disposition saved.');
    }
    ...
    public function bulk(Request $request)
    {
        ...
        return redirect()->route('dashboard.user.marketing-bot.voice.calls.index')->with('success', 'Bulk action applied.');
    }
}
