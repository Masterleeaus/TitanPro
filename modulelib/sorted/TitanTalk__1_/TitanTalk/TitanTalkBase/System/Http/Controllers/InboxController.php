...
use App\Extensions\MarketingBot\System\Services\TitanTalk\Realtime\PanelRealtimePublisher;
use App\Extensions\MarketingBot\System\Services\TitanTalk\Realtime\SessionRealtimePublisher;
...
class InboxController extends Controller
{
    ...
    public function store(Request $request): ChatbotHistoryResource|JsonResponse
    {
        ...
        PanelRealtimePublisher::publishConversation($marketingConversation->loadMissing('lastMessage'), $history);
        if ($marketingConversation->getAttribute('session_id')) {
            SessionRealtimePublisher::publishMessage($history, (string) $marketingConversation->getAttribute('session_id'));
        }
