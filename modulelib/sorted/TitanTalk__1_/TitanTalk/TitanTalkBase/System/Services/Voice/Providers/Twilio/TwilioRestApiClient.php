...
class TwilioRestApiClient
{
    ...
    {
        $this->baseUrl = rtrim((string) config('titantalk.twilio.base_url', 'https://api.twilio.com/2010-04-01/Accounts'), '/');
        $this->accountSid = (string) config('titantalk.twilio.account_sid');
        $this->authToken = (string) config('titantalk.twilio.auth_token');
    }
