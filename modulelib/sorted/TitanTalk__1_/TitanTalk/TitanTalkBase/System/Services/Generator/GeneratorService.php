...
class GeneratorService
{
    ...
    public ?string $additionalSystemContext = null;
    ...
    public function generate(): string
    {
        ...
        $generated = $generator
            ...
            ->setAdditionalSystemContext($this->additionalSystemContext)
            ->generate();
    ...
    public function setAdditionalSystemContext(?string $additionalSystemContext): static
    {
        $this->additionalSystemContext = $additionalSystemContext;
