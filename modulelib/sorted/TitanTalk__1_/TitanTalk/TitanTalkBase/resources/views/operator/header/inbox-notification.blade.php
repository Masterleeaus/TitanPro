<x-button
    ...
    size="none"
    href="{{ route('dashboard.user.titan-talk.operator.index') }}"
...
>
    <span
        ...
        id="inbox-notification-marketing-bot"
    >0</span>
    <x-tabler-inbox
        ...
        <script>
            $(document).ready(function() {
                ...
                function fetchNotificationCount() {
                    $.ajax({
                        url: '{{ route('dashboard.user.titan-talk.operator.notification.count') }}',
                        type: 'GET',
                        success: function(data) {
                            let inboxNotification = $('#inbox-notification-marketing-bot');
