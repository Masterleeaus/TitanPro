...
@section('title', __('TitanTalk Operator'))
...
@section('content')
    <div
        ...
        x-data="titanTalkOperatorMessages"
    >
        <div
        ...
        >
            @includeIf('marketing-bot::operator.particles.conversations-filter')
            ...
            >
                @includeIf('marketing-bot::operator.particles.conversations-sort')

                @includeIf('marketing-bot::operator.particles.conversations-channel-filter')

                @include('marketing-bot::operator.particles.conversations-list')
            </div>
        </div>
        ...
        >
            @include('marketing-bot::operator.particles.messages-header')
            ...
            >
                <div class="mt-auto space-y-2 px-4 xl:px-10">
                    @include('marketing-bot::operator.particles.messages-list')
                </div>

                @include('marketing-bot::operator.particles.messages-form')
            </div>
        </div>
        ...
        >
            @include('marketing-bot::operator.particles.contact-info-head')

            <div class="grid grow grid-cols-1 place-items-start overflow-y-auto">
                @include('marketing-bot::operator.particles.contact-info-tab-details')
                @include('marketing-bot::operator.particles.contact-info-tab-history')
                @includeIf('titantalk::operator.particles.copilot-panel')
            </div>
        </div>
    </div>
@endsection
    ...
    <script>
        (() => {
            document.addEventListener('alpine:init', () => {
                Alpine.data('titanTalkOperatorMessages', () => ({
                    selectedStatus: {
                        label: '{{ __('All') }}',
                        count: 0,
                        status: 'all'
                    ...
                    async init() {
                        ...
                        Alpine.store('titanTalkOperatorMessages', this);
                    ...
                    async updateConversationDetails({
                        ...
                        @else
                            ...
                            const res = await fetch('{{ route('dashboard.user.titan-talk.operator.conversations.update') }}', {
                                method: 'PUT',
                                headers: {
                    ...
                    async onSendMessage() {
                        ...
                        @else
                            ...
                            const sendFirstMessage = async () => {
                                ...
                                const res = await fetch('{{ route('dashboard.user.titan-talk.operator.history') }}', {
                                    method: 'POST',
                                    headers: {
                                        'Accept': 'application/json',
                                    },
                    ...
                    async fetchHistories(id) {
                        const res = await fetch('{{ route('dashboard.user.titan-talk.operator.history') }}?conversation_id=' + id, {
                            method: 'GET',
                            headers: {
                                'Content-Type': 'application/json',
                                'Accept': 'application/json',
                    ...
                    async handleConversationsSearch() {
                        ...
                        const res = await fetch('{{ route('dashboard.user.titan-talk.operator.conversations.search') }}', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'Accept': 'application/json',
                    ...
                    async exportHistory(conversationId) {
                        ...
                        @else
                            ...
                            fetch('{{ route('dashboard.user.titan-talk.operator.history') }}?conversation_id=' + conversationId)
                    ...
                    async closeConversation(conversationId) {
                        ...
                        const res = await fetch('{{ route('dashboard.user.titan-talk.operator.conversations.closed') }}?conversation_id=' + conversationId, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'Accept': 'application/json',
                    ...
                    async pinConversation(conversationId) {
                        ...
                        const res = await fetch('{{ route('dashboard.user.titan-talk.operator.conversations.pinned') }}?conversation_id=' + conversationId, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'Accept': 'application/json',
                    ...
                    async getConversationsHistory(sessionId) {
                        ...
                        const res = await fetch(
                            `{{ route('dashboard.user.titan-talk.operator.conversations.history.session') }}?sessionId=${sessionId}`, {
                                method: 'GET',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'Accept': 'application/json',
                    ...
                    async deleteConversation(conversationId) {
                        ...
                        @else
                            ...
                            const res = await fetch('{{ route('dashboard.user.titan-talk.operator.destroy') }}', {
                                method: 'DELETE',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'Accept': 'application/json',
