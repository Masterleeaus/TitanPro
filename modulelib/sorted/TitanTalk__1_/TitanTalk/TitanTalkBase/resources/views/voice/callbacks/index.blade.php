  ...
  <form class="card card-body mb-3" method="get">
    ...
    <div class="row g-2">
      ...
      <div class="col-md-3 d-flex align-items-end gap-2">
        ...
        <a class="btn btn-outline-secondary" href="{{ route('dashboard.user.marketing-bot.voice.callbacks.index', ['company_id'=>request('company_id')]) }}">Reset</a>
      </div>
    </div>
  </form>
        ...
        <tbody>
          @forelse($callbacks as $cb)
            <tr>
              ...
              <td class="text-end">
                <a class="btn btn-sm btn-outline-primary" href="{{ route('dashboard.user.marketing-bot.voice.callbacks.show', ['company_id'=>request('company_id'),'id'=>$cb->id]) }}">Open</a>
              </td>
            </tr>
          @empty
