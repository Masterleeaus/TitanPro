...
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div>
            ...
            <div>@include('marketing-bot::voice.calls.partials.badge', ['call' => $call])</div>
        </div>
        <div class="d-flex gap-2">
            <a class="btn btn-outline-secondary" href="{{ route('dashboard.user.marketing-bot.voice.calls.index') }}">Back to inbox</a>
        </div>
    </div>
...
<div class="row g-3">
        <div class="col-lg-4">
            ...
            <div class="card mb-3"><div class="card-body">
                ...
                @include('marketing-bot::voice.calls.partials.assign_form')
            </div></div>

            <div class="card mb-3"><div class="card-body">
                <h5 class="card-title mb-3">Disposition</h5>
                @include('marketing-bot::voice.calls.partials.disposition_form')
            </div></div>

            <div class="card"><div class="card-body">
                <h5 class="card-title mb-3">Callback</h5>
                @include('marketing-bot::voice.calls.partials.callback_form')
            </div></div>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    @include('marketing-bot::voice.calls.partials.recordings')
                </div>
            </div>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    @include('marketing-bot::voice.calls.partials.timeline')
                </div>
            </div>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="mb-3">@include('marketing-bot::voice.calls.partials.note_form')</div>
                    @include('marketing-bot::voice.calls.partials.notes_list')
                </div>
            </div>
        </div>
    </div>
