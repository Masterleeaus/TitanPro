...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="{{ route('dashboard.user.marketing-bot.voice.campaigns.create') }}" class="btn btn-primary">Create Campaign</a>
</div>
    ...
    <table class="table mb-0">
      ...
      @foreach($campaigns as $c)
        <tr>
          ...
          <td class="text-end">
            <a class="btn btn-sm btn-outline-primary" href="{{ route('dashboard.user.marketing-bot.voice.campaigns.edit', $c->id) }}">Manage</a>
            <form method="POST" action="{{ route('dashboard.user.marketing-bot.voice.campaigns.delete', $c->id) }}" style="display:inline">
              @csrf
