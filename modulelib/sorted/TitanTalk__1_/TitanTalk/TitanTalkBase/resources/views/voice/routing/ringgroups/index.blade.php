...
<div class="d-flex justify-content-between align-items-center mb-3">
  <h4>Ring Groups</h4>
  <a href="{{ route('dashboard.user.marketing-bot.voice.routing.ringgroups.create') }}" class="btn btn-primary">Create Ring Group</a>
</div>
    ...
    <table class="table mb-0">
      ...
      @foreach($groups as $g)
        <tr>
          ...
          <td class="text-end">
            <a class="btn btn-sm btn-outline-primary" href="{{ route('dashboard.user.marketing-bot.voice.routing.ringgroups.edit', $g->id) }}">Edit</a>
            <form action="{{ route('dashboard.user.marketing-bot.voice.routing.ringgroups.delete', $g->id) }}" method="POST" style="display:inline">
              @csrf
