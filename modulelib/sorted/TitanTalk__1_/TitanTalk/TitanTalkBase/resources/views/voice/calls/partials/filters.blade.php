<form method="GET" class="row g-2 align-items-end" data-titantalk-filters>
    <div class="col-md-2">
    ...
    <div class="col-12 d-flex gap-2">
        ...
        <a class="btn btn-outline-secondary" href="{{ route('dashboard.user.marketing-bot.voice.calls.index') }}" data-titantalk-clear>Clear</a>
    </div>
</form>