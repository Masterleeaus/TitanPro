...
<div class="d-flex justify-content-between align-items-center mb-3">
  <h4>IVR Menus</h4>
  <a href="{{ route('dashboard.user.marketing-bot.voice.routing.ivr.create') }}" class="btn btn-primary">Create IVR Menu</a>
</div>
    ...
    <table class="table mb-0">
      ...
      @foreach($menus as $m)
        <tr>
          ...
          <td class="text-end">
            <a class="btn btn-sm btn-outline-primary" href="{{ route('dashboard.user.marketing-bot.voice.routing.ivr.edit', $m->id) }}">Edit</a>
            <form method="POST" action="{{ route('dashboard.user.marketing-bot.voice.routing.ivr.delete', $m->id) }}" style="display:inline">
              @csrf
