...
return new class extends Migration {
    ...
    {
        Schema::create('titantalk_ivr_menus', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('titantalk_ivr_options', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('titantalk_ivr_options');
        Schema::dropIfExists('titantalk_ivr_menus');
    }
};
