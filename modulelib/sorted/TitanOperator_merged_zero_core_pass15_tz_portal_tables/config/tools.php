...
/**
 * Tool registry for the TitanOperator workflow engine.
 *
 * Webhook-first (Strategy B): tools are primarily dispatched to the titan_operator's
 * configured external tool gateway (tz_portal_operator_bots.external_endpoint_url).
 *
 * Tools can be enabled/disabled per titan_operator from the dashboard.
 */
