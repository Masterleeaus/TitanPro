...
/**
 * TitanOperator Workflows Registry (Horizontal / Multi-tenant)
 *
 * Strategy B (locked): workflows execute via a webhook "tool gateway".
 * The titan_operator NEVER directly mutates business objects.
 */
...
return [
    ...
    /**
     * Workflows are enabled per titan_operator (DB). If no DB row exists, default_enabled applies.
     */
    'workflows' => [
