...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('tz_portal_operator_avatars')) {
            Schema::create('tz_portal_operator_avatars', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('tz_portal_operator_avatars');
    }
};