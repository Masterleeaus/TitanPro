...
class ChatbotTrainingController extends Controller
{
    public function qa(Request $request, Chatbot $chatbot): \Illuminate\Http\JsonResponse
    {
        if (Helper::appIsDemo()) {
            return response()->json([
                ...
                'content' => view('titanzero-chat::settings.qa-tab', [
    ...
    public function text(Request $request, Chatbot $chatbot)
    {
        if (Helper::appIsDemo()) {
            return response()->json([
                'status'  => 'error',
                'message' => trans('This feature is disabled in demo mode.'),
                'content' => view('titanzero-chat::settings.text-tab', [
    ...
    public function uploadPdf(Request $request, Chatbot $chatbot)
    {
        if (Helper::appIsDemo()) {
            return response()->json([
                'status'  => 'error',
                'message' => trans('This feature is disabled in demo mode.'),
                'content' => view('titanzero-chat::settings.pdf-tab', [
    ...
    {
        return response()->json([
            'content' => view('titanzero-chat::webchat.crawler', [
    ...
    public function training(
        ...
        $matchView = match ($type) {
            'url'  => 'titanzero-chat::webchat.crawler',
            'pdf'  => 'titanzero-chat::settings.pdf-tab',
            'text' => 'titanzero-chat::settings.text-tab',
            'qa'   => 'titanzero-chat::settings.qa-tab',
        };
