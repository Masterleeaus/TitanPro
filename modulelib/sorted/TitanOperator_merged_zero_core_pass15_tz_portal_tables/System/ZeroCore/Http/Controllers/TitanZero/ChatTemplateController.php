...
class ChatTemplateController extends Controller
{
    public function index()
    {
        ...
        return view('titanzero-chat::settings.form', compact('list'));
    }
    ...
    public function create()
    {
        ...
        return view('titanzero-chat::settings.form', [
            ...
            'action'       => route('user.tzc.settings.templates.store'),
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user.tzc.settings.templates.index')->with([
            'type'    => 'success',
    ...
    public function edit(OpenaiGeneratorChatCategory $chatTemplate)
    {
        ...
        return view('titanzero-chat::settings.form', [
            'title'        => 'Create Chat Template',
            'action'       => route('user.tzc.settings.templates.update', $chatTemplate),
            'categoryList' => $categoryList,
            'chatbots'     => $chatbots,
            'method'       => 'PUT',
