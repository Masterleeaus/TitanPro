...
class ChatbotController extends Controller
{
    public function index(): View
    {
        ...
        return view('titanzero-chat::settings.setting', [
    ...
    public function create(): RedirectResponse
    {
        ...
        return to_route('user.tzc.settings.chatbots.show', $item->getAttribute('id'));
    }
    ...
    public function store(ChatbotRequest $request)
    {
        ...
        return to_route('user.tzc.settings.chatbots.index')->with('success', trans('Chatbot Template Created Successfully'));
    }
    ...
    public function show(Chatbot $chatbot)
    {
        ...
        return view('titanzero-chat::settings.training', [
            'title'  => trans('Chatbot Training'),
            'item'   => $chatbot,
            'data'   => $chatbot->data()->get(),
            'action' => route('user.tzc.settings.chatbots.update', $chatbot),
        ]);
    }
    ...
    public function edit(Chatbot $chatbot)
    {
        ...
        return view('titanzero-chat::settings.form', [
