...
use App\Extensions\TitanOperator\System\Enums\HeaderBgEnum;
use App\Extensions\TitanOperator\System\Enums\PositionEnum;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class TitanOperatorCustomizeRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            'id'                            => ['required', 'integer', 'exists:tz_portal_operator_bots,id'],
