...
class TitanOperatorController extends Controller
{
    ...
    public function embed(TitanOperator $titan_operator): View
    {
    ...
    public function enbed(TitanOperator $titan_operator): RedirectResponse
    {
        return redirect()->route('dashboard.user.titan_operator.embed', ['titan_operator' => $titan_operator]);
    }
