...
@section('titlebar_subtitle', __('Share a web link, and let the titan_operator delve into the content, providing relevant insights and opinions.'))
@section('titlebar_actions', '')

@section('chat_sidebar_actions', '')

@section('openChatAreaContainerUrl', '/dashboard/user/chat/webchat/open-chat-area-container')
...
@section('chat_head_actions')
    ...
    >
        ...
        <input
            ...
            type="hidden"
            name="createChatUrl"
            value="/dashboard/user/chat/webchat/start-new-chat"
        />

        <x-forms.input
            class="w-full rounded-full lg:min-w-96"
            id="website_url"
            type="text"
            name="website_url"
...
@push('script')
    <script src="{{ asset('vendor/web-chat/js/openai_webchat.js') }}"></script>
@endpush
