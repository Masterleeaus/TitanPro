    ...
    <div class="py-10">
        <div class="mx-auto w-full md:w-8/12 xl:w-5/12">
            ...
            >
                ...
                <div>
                    ...
                    >
                        @lang('Need help?')
                        <x-info-tooltip
                                text="{{ __('You can deploy your trained titan_operator to an existing AI Chat template. Simply navigate to Chat Templates select Edit Template, and assign your titan_operator there.') }}"
                        />
                    </a>
                </div>
            </form>
            ...
            <div x-data="{
                ...
                <div>
                    @include('titanzero-chat::titan_operator.particles.web-site-tab')
                    @include('titanzero-chat::titan_operator.particles.pdf-tab')
                    @include('titanzero-chat::titan_operator.particles.text-tab')
                    @include('titanzero-chat::titan_operator.particles.qa-tab')
                </div>
            </div>
        </div>
...
@push('script')
    <script src="{{ custom_theme_url('assets/js/panel/admin.titan_operator.js') }}"></script>
@endpush
