<div :class="{ 'hidden': activeTab !== 'website' }">
    ...
    >
        ...
        <div class="relative">
            ...
            <x-button
                    ...
                    data-action="{{ route('user.tzc.settings.titan_operators.web-sites', $item) }}"
                    variant="link"
                    size="none"
                    type="button"
            >
    ...
    <form
            ...
            action="{{ route('user.tzc.settings.titan_operators.training', $item->id) }}"
    >
        @csrf
        <input
                id="type"
        ...
        <div
                ...
                id="titan_operatorPages"
        >
            @include('titanzero-chat::titan_operator.particles.web-site.crawler', ['items' => $websites])
        </div>
    </form>
</div>
