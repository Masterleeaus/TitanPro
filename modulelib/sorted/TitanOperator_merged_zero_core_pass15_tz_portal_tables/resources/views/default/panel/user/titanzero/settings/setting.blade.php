            ...
            <div class="row g-2 items-center">
                <div class="col">
                    <div class="hstack gap-1">
                        ...
                        <a href="{{route('dashboard.admin.titan_operator.index')}}" class="page-pretitle flex items-center">
                            / {{__('TitanOperator Templates')}}
                        </a>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('titan_operator_status') is-invalid @enderror" name="titan_operator_status" id="titan_operator_status">
                                        <option value="disabled" {{$settings_two->titan_operator_status == 'disabled' ? 'selected' : null}}>{{__('Disabled')}}</option>
                                        <option value="frontend" {{$settings_two->titan_operator_status == 'frontend' ? 'selected' : null}}>{{__('Frontend')}}</option>
                                        <option value="dashboard" {{$settings_two->titan_operator_status == 'dashboard' ? 'selected' : null}}>{{__('Dashboard')}}</option>
                                        <option value="both" {{$settings_two->titan_operator_status == 'both' ? 'selected' : null}}>{{__('Both')}}</option>
                                    </select>
                                    @error('titan_operator_status')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('titan_operator_template') is-invalid @enderror" name="titan_operator_template" id="titan_operator_template">
                                        @foreach($titan_operatorData as $titan_operator)
                                            <option value="{{$titan_operator->id}}" {{$settings_two->titan_operator_template == $titan_operator->id ? 'selected' : null}}>{{__($titan_operator->title)}}</option>
                                        @endforeach
                                    </select>
                                    @error('titan_operator_template')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-selectgroup">
                                        <label class="form-selectgroup-item">
                                            <input type="radio" name="position" value="top-left" class="form-selectgroup-input" {{$settings_two->titan_operator_position == 'top-left' ? 'checked' : null}} />
                                        ...
                                        <label class="form-selectgroup-item">
                                            <input type="radio" name="position" value="top-right" class="form-selectgroup-input" {{$settings_two->titan_operator_position == 'top-right' ? 'checked' : null}} />
                                            <span class="form-selectgroup-label">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                        ...
                                        <label class="form-selectgroup-item">
                                            <input type="radio" name="position" value="bottom-right" class="form-selectgroup-input" {{$settings_two->titan_operator_position == 'bottom-right' ? 'checked' : null}} />
                                            <span class="form-selectgroup-label">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                        ...
                                        <label class="form-selectgroup-item">
                                            <input type="radio" name="position" value="bottom-left" class="form-selectgroup-input" {{$settings_two->titan_operator_position == 'bottom-left' ? 'checked' : null}} />
                                            <span class="form-selectgroup-label">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('titan_operator_rate_limit') is-invalid @enderror" type="number" name="titan_operator_rate_limit" id="titan_operator_rate_limit" min="2" max="50" default="2" value="{{$settings_two->titan_operator_rate_limit}}">
                                    @error('titan_operator_rate_limit')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    <label class="form-check form-switch" for="logged_in">
                                        <input class="form-check-input" name="titan_operator_login_require" type="checkbox" id="titan_operator_login_require" {{ $settings_two->titan_operator_login_require == true ? 'checked' : '' }}>
