            ...
            <x-slot:modal>
                ...
                >
                    ...
                    <p class="mb-4 text-pretty text-sm text-heading-foreground/70">
                        {{ __('To enhance its responses, your titan_operator can remember non-sensitive information about you, allowing it to replay faster, more accurately and in a more personalized manner.') }}
                    </p>
                    ...
                    function instructionsManager(chatId) {
                        return {
                            ...
                            async loadInstructions() {
                                ...
                                try {
                                    const response = await fetch(`/dashboard/user/chat/memory/instructions?chat_id=${this.chatId}`, {
                                        headers: {
                            ...
                            async saveInstructions() {
                                ...
                                try {
                                    const response = await fetch('/dashboard/user/chat/memory/instructions', {
                                        method: 'POST',
                                        headers: {
