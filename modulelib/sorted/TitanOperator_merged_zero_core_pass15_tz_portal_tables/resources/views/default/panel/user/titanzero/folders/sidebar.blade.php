    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('folderManager', ({
                ...
                async fetchFolders() {
                    try {
                        const response = await this.makeRequest('/dashboard/user/titanzero/folders', {
                            method: 'GET'
                        });
                ...
                async fetchChats(append = false) {
                    ...
                    try {
                        ...
                        const response = await this.makeRequest(
                            `/dashboard/user/titanzero/chats?${params.toString()}`, {
                                method: 'GET'
                            }
                        );
                ...
                async renameFolder(folderId, folderName) {
                    ...
                    try {
                        const response = await this.makeRequest(
                            `/dashboard/user/titanzero/folders/${folderId}`, {
                                method: 'PUT',
                                body: JSON.stringify({
                                    name: folderName
                                })
                ...
                async moveToFolder(chatId, folderId) {
                    try {
                        const response = await this.makeRequest(
                            `/dashboard/user/titanzero/chats/${chatId}/move-to-folder`, {
                                method: 'POST',
                                body: JSON.stringify({
                                    folder_id: folderId
                                })
