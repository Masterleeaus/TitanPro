<template x-for="(message, index) in activeChat?.histories">
    <div
        class="lqd-ext-titan_operator-history-message flex max-w-[430px] gap-2"
    ...
    >
        ...
        <div class="lqd-ext-titan_operator-history-message-content-wrap space-y-1 lg:max-w-[420px]">
            <div
                class="lqd-ext-titan_operator-history-message-content w-fit rounded-xl p-3"
                :class="{
