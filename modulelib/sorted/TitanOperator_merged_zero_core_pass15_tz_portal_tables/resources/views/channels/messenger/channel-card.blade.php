@php
	$image = 'vendor/titan-operator-multi-channel/icons/messenger.svg';
	$image_dark_version = 'vendor/titan-operator-multi-channel/icons/messenger-light.svg';
...
>
	...
	<x-slot:modal>
		...
		<form id="storeForm-messenger" class="" action="{{ route('dashboard.titan_operator_multi_channel.messenger.store') }}">
