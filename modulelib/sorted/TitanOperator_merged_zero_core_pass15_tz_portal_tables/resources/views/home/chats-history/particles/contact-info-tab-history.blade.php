<div
    ...
    x-show="contactInfo.activeTab === 'history'"
    x-transition.opacity
>
    <div class="h-full overflow-y-auto">
        <ul class="lqd-ext-titan-operator-history-list">
            <template x-for="(chatItem, index) in userConversationHistory">
                <li
                    class="lqd-ext-titan-operator-history-list-item group/chat-item relative border-b px-6 py-4 before:absolute before:inset-x-2.5 before:inset-y-1.5 before:z-0 before:scale-95 before:rounded-xl before:bg-primary/10 before:opacity-0 before:transition [&.active]:before:scale-100 [&.active]:before:opacity-100"
            ...
            <template x-if="!userConversationHistory.length">
