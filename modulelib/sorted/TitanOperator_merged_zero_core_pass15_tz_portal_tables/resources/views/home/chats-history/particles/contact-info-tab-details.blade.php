...
>
    ...
    <div class="mb-2.5 flex items-center justify-center gap-3 font-medium opacity-70">
        ...
        <span
            x-text="activeChat?.titan_operator_channel && activeChat.titan_operator_channel === 'frame' ? '{{ __('Live Chat') }}' : activeChat?.titan_operator_channel ? activeChat.titan_operator_channel : '---'"
        ></span>
    </div>
