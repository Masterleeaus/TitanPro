...
>
    <h2 class="mb-3.5">
        @lang('TitanOperator Training')
    </h2>
    <p class="mb-3 text-xs/5 opacity-60 lg:max-w-[360px]">
        @lang('This step is optional but highly recommended to personalize your client portal experience.')
    </p>
    <x-button
    ...
    @endphp
    <div class="lqd-ext-titan-operator-training mt-16 flex flex-col justify-center gap-9">
        ...
        <div class="lqd-ext-titan-operator-training-content grid">
