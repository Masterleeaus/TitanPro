...
>
    ...
    <div class="flex flex-col gap-7 pt-9">
        ...
        <div>
            <x-forms.input
                class:label="text-heading-foreground"
                label="{{ __('Client Portal Instructions') }}"
        ...
        <div>
            <x-forms.input
                ...
                type="checkbox"
                switcher
                x-model.boolean="activeTitanOperator.do_not_go_beyond_instructions"
            />
        ...
        @includeIf('titan_operator-agent::particles.titan_operator-config')
        ...
        {{--                size="lg" --}}
        {{--                type="select" --}}
        {{--                x-model="activeTitanOperator.ai_model" --}}
        {{--                x-ref="aiModelSelect" --}}
        {{--            > --}}
