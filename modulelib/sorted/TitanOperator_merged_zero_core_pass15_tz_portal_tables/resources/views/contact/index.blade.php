            ...
            <x-slot:body>
                @foreach ($items as $entry)
                    <tr id="template-{{ $entry->id }}">
                        ...
                        <td>
                            {{ __($entry->titan_operator_channel) }}
                        </td>
                        <td>
                            <p class="m-0">
                        ...
                        <td class="whitespace-nowrap text-end">
                            <x-button
                                ...
                                href="{{ route('dashboard.titan_operator.titan_operator-customer.edit', $entry->id) }}"
                                title="{{ __('Edit') }}"
                            >
                            ...
                            <form
                                method="POST"
                                action="{{ route('dashboard.titan_operator.titan_operator-customer.destroy', $entry->id) }}"
