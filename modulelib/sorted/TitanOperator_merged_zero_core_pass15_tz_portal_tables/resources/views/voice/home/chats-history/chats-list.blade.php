<ul class="lqd-ext-titan_operator-history-list flex flex-col gap-2">
    <template
        x-for="(chatItem, index) in chatsList"
        x-show="chatsList.length"
    >
        <li
            class="lqd-ext-titan_operator-history-list-item group/chat-item relative rounded-xl px-5 py-3.5 text-heading-foreground transition-colors hover:bg-heading-foreground/5 [&.lqd-active]:bg-heading-foreground/5"
        ...
        >
            ...
            <a
                class="lqd-ext-titan_operator-history-list-item-trigger absolute start-0 top-0 inline-block h-full w-full"
                :data-id="chatItem.id"
                href="#"
