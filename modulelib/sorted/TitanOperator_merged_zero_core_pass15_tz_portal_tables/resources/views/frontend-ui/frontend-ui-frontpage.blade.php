...
>
    <div
        class="lqd-ext-titan-operator-window before:pointer-events-none before:absolute before:bottom-0 before:z-3 before:h-40 before:w-full before:bg-gradient-to-t before:from-[--lqd-ext-chat-window-bg] before:from-40% before:to-transparent before:to-85%">
        <div class="lqd-ext-titan-operator-window-contents-wrap grid grow place-items-start overflow-hidden">
...
<script
    defer
    src="{{ asset('vendor/titan_operator/js/alpine.min.js') }}"
></script>

@if (\App\Helpers\Classes\MarketplaceHelper::isRegistered('titan_operator-agent'))
    <script
