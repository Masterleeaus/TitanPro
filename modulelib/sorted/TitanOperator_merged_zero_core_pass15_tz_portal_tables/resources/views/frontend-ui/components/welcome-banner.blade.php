<div class="lqd-ext-titan-operator-window-welcome-banner">
    <div class="mb-28 flex items-center gap-2.5 text-white">
        @if ($is_editor)
            <img
                class="lqd-ext-titan-operator-window-head-logo"
            ...
            <h4
                class="lqd-ext-titan-operator-window-head-title text-current"
        ...
        @else
            ...
            @endif
            <h4 class="lqd-ext-titan-operator-window-head-title">
    ...
    <button
        class="lqd-ext-titan-operator-window-welcome-button relative flex w-full items-center gap-3.5 rounded-full bg-white/25 p-4 text-start text-white shadow-2xl backdrop-blur-md transition-all before:pointer-events-none before:absolute before:-inset-px before:z-0 before:rounded-full before:border before:border-white before:opacity-35 before:[mask-image:linear-gradient(to_bottom,black,transparent)] hover:-translate-y-1 hover:bg-white hover:text-black hover:shadow-white/20 sm:px-[22px] sm:py-[18px]"
