...
@section('titlebar_actions')
    <x-button
        variant="primary"
        href="{{ route('dashboard.titan_operator.knowledge-base-article.create') }}"
    >
        {{ __('Add Article') }}
    </x-button>
@endsection
                    ...
                    <tr id="template-{{ $entry->id }}">
                        ...
                        <td class="whitespace-nowrap text-end">
                            <x-button
                                ...
                                href="{{ route('dashboard.titan_operator.knowledge-base-article.edit', $entry->id) }}"
                                title="{{ __('Edit') }}"
                            >
                            ...
                            <form
                                method="POST"
                                action="{{ route('dashboard.titan_operator.knowledge-base-article.destroy', $entry->id) }}"
