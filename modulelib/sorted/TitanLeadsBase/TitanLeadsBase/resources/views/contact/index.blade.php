    ...
    >
        ...
        <x-slot:modal>
            ...
            <form
                class="space-y-5"
                id="submit"
                action="{{ route('dashboard.user.titan-leads.contact.store') }}"
                method="post"
            >
                @csrf
                <x-forms.input
                    ...
                    <tr>
                        ...
                        <td class="whitespace-nowrap text-end">
                            ...
                            @else
                                <x-button
                                    class="size-9"
                                    href="{{ route('dashboard.user.titan-leads.contact.edit', $item->id) }}"
                                    variant="ghost-shadow"
                                    size="none"
                                    title="{{ __('Delete') }}"
                                >
                                ...
                                <x-button
                                    class="size-9"
                                    data-delete="delete"
                                    data-delete-link="{{ route('dashboard.user.titan-leads.contact.destroy', $item->id) }}"
                                    variant="ghost-shadow"
                                    hover-variant="danger"
                                    size="none"
                                    title="{{ __('Delete') }}"
