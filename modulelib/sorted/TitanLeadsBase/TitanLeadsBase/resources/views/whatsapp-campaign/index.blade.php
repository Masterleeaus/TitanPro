...
@section('titlebar_actions')
    <div class="flex gap-4 lg:justify-end">
        <x-button href="{{ route('dashboard.user.titan-leads.whatsapp-campaign.create') }}">
                    ...
                    <tr>
                        ...
                        <td class="whitespace-nowrap text-end">
                            ...
                            @else
                                ...
                                <x-button
                                    class="size-9"
                                    href="{{ route('dashboard.user.titan-leads.whatsapp-campaign.edit', $item->id) }}"
                                    variant="ghost-shadow"
                                    size="none"
                                    title="{{ __('Edit') }}"
                                >
                                ...
                                <x-button
                                    class="size-9"
                                    data-delete="delete"
                                    data-delete-link="{{ route('dashboard.user.titan-leads.whatsapp-campaign.destroy', $item->id) }}"
                                    variant="ghost-shadow"
                                    hover-variant="danger"
                                    size="none"
                                    title="{{ __('Delete') }}"
