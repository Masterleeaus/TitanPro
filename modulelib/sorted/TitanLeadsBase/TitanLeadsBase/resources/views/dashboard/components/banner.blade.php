<div
        ...
        <div class="!flex flex-nowrap items-center justify-center gap-2.5 group-hover:motion-preset-confetti">
            <div class="size-16">
                <img
                    ...
                    src="{{ asset('vendor/titan-leads/images/telegram_banner.png') }}"
                    alt="@lang('Like Image')"
                >
            </div>
            <div class="size-16">
                <img
                    class="h-full w-full object-cover"
                    src="{{ asset('vendor/titan-leads/images/whatsapp_banner.png') }}"
                    alt="@lang('Like Image')"
                >
            </div>
        </div>
    ...
    <div class="md:ms-auto">
        <x-button
            href="{{ route('dashboard.user.titan-leads.settings.index') }}"
