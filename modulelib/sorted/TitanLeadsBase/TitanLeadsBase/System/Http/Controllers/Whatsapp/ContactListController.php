...
use App\Extensions\TitanLeads\System\Http\Requests\ContactListRequest;
...
class ContactListController extends Controller
{
    ...
    {
        return view('titan-leads::contact-list.index', [
    ...
    {
        return view('titan-leads::contact-list.edit', [
            ...
            'method'           => 'POST',
            'action'           => route('dashboard.user.titan-leads.contact-list.store'),
    ...
    public function store(ContactListRequest $request): \Illuminate\Http\RedirectResponse
    {
        ...
        return to_route('dashboard.user.titan-leads.contact-list.index')->with([
            'status'  => 'success',
    ...
    public function edit(ContactList $contactList)
    {
        ...
        return view('titan-leads::contact-list.edit', [
            ...
            'item'             => $contactList,
            'method'           => 'PUT',
            'action'           => route('dashboard.user.titan-leads.contact-list.update', $contactList->id),
