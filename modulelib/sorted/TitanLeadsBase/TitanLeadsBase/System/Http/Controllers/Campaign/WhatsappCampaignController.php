...
use App\Extensions\TitanLeads\System\Http\Requests\Campaign\CampaignWhatsappRequest;
...
class WhatsappCampaignController extends Controller
{
    ...
    {
        return view('titan-leads::whatsapp-campaign.index', [
    ...
    {
        return view('titan-leads::whatsapp-campaign.create', [
            'title'            => trans('New WhatsApp Campaign'),
            'action'           => route('dashboard.user.titan-leads.whatsapp-campaign.store'),
            'method'           => 'POST',
    ...
    public function store(CampaignWhatsappRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('dashboard.user.titan-leads.whatsapp-campaign.index')
            ->with([
                'type'    => 'success',
    ...
    public function edit(Request $request, MarketingCampaign $whatsappCampaign): View
    {
        ...
        return view('titan-leads::whatsapp-campaign.create', [
            ...
            'action'          => route('dashboard.user.titan-leads.whatsapp-campaign.update', $whatsappCampaign->getKey()),
            'method'          => 'PUT',
