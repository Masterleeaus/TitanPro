@php
    $banner_bg_light = asset('vendor/command-agent/images/img-6.jpg');
    $banner_bg_dark = asset('vendor/command-agent/images/img-6-dark.png');
@endphp
...
<div
    class="command-agent-banner relative flex flex-wrap items-center overflow-hidden rounded-2xl bg-cover bg-top [background-image:url('{{ $banner_bg_light }}')] dark:bg-white/[2%] dark:[background-image:url('{{ $banner_bg_dark }}')] lg:min-h-[50vmin] lg:flex-nowrap">
        ...
        <h2 class="mb-7 text-[30px] leading-[1.05em]">
            <span class="block text-[21px]">
                <span class="opacity-50">
                    @lang('We’re your channels agents')
                </span>
                👋
            </span>
            @lang('We learn and improve over time.')
        </h2>
    ...
    <div class="-order-1 flex justify-end lg:absolute lg:end-0 lg:top-0 lg:h-full lg:max-w-[calc(100%-600px)]">
        <figure class="lg:h-full">
            <img
                ...
                width="590"
                height="627"
                src="{{ asset('vendor/command-agent/images/img-8.png') }}"
            ...
            <img
                ...
                width="169"
                height="171"
                src="{{ asset('vendor/command-agent/images/img-7.png') }}"
