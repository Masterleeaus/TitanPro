<div class="py-10">
    @if ($agents->isEmpty())
        ...
        <p class="mb-5">
            @lang('Create your first AI channels agent to automate your posting across multiple containers')
        </p>
        <x-button
...
{{--										method="Sub-item"--}}
										onsubmit="return confirm('@lang('Are you sure you want to delete this agent? All associated sub-items will also be deleted.')')"
									>
										@csrf
										@method('DELETE')
										<x-button
                    ...
                    @if (filled($agent->platform_ids))
                        <div class="mb-4 flex flex-wrap justify-center gap-2">
                            @foreach ($agent->platform_ids as $platform_id)
                                @php
                                    $container = $containers->firstWhere('id', $platform_id);
