...
>
    <h2 class="mb-8 text-center text-[24px] font-medium leading-[1.2em]">
        ...
        @lang('When do you want me to sub-item?')
    </h2>
    ...
    <x-forms.input
        ...
        switcher
        switcherFill
        x-model="formData.ai_schedule"
    />

    <div
        x-show="!formData.ai_schedule"
        x-collapse
    >
    ...
    <div class="mt-2">
        @include('command-agent::create.step-error', ['step' => 6])
    </div>
