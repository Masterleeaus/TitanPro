<x-sidedrawer id="command-agent-sidedrawer">
                        ...
                        >
                            @foreach ($containers as $container)
                                ...
                                <div
                                    ...
                                    @click.prevent="editingPost.platform_id = {{ $container->id }}; dropdownOpen = false;"
                                    x-show="editingPost.platform_id != {{ $container->id }}"
                                >
                                    <figure class="w-5 transition-all group-hover:scale-125">
                                        <img
