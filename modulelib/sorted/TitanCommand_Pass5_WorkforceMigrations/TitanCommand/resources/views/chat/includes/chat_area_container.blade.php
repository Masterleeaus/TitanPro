@php
    ...
    $example_prompts = collect([
        ...
        ['name' => '📈 Item recap', 'prompt' => 'Summarize our latest social item performance in 5 bullet points.'],
        ...
        ['name' => '🏷️ Hashtag set', 'prompt' => 'Recommend 15 trending hashtags for a wellness sub-item.'],
...
>
    ...
    <div class="relative flex grow flex-col">
        ...
        <div @class([
            ...
            <div
                ...
                >
                    <img
                        src="{{ @asset('/vendor/command-agent/images/img-10.png') }}"
                        alt="{{ __('AI Channels Agent') }}"
                        width="300"
                        height="265"
                    >
                </figure>
                <h2 class="mb-8 text-center text-[30px] font-medium leading-[1.1em] md:text-[34px] lg:text-[clamp(34px,2vw,40px)]">
                    ...
                    <br>
                    {{ __('Ask me anything about channels.') }}
                </h2>
    ...
    @if (view()->hasSection('chat_form'))
        @yield('chat_form')
    @else
        @include('command-agent::chat.includes.chat_form')
    @endif
</div>
