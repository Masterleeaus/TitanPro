...
class TitanCommand extends Model
{
    use SoftDeletes;

    protected $table = 'ext_titancommands';
    ...
    public function image(): Attribute
    {
        return Attribute::make(
            get: fn () => asset('vendor/titancommand/images/agent-default.png'),
        );
    }
    ...
    {
        return $this->hasMany(TitanCommandPost::class, 'agent_id');
    }

    public function platforms()
    {
        return CommandPlatform::whereIn('id', $this->platform_ids ?? [])->get();
    }
