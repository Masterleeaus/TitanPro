namespace App\Extensions\TitanCommand\System\JobManager\Resources\views\settings;
...
<div class="container">
  ...
  <form method="post" action="{{ route('jobmanager.settings.update') }}">
    @csrf
    <div class="mb-3">
    ...
    <div class="mt-4">
      <form method="post" action="{{ route('jobmanager.settings.test') }}">
        @csrf
