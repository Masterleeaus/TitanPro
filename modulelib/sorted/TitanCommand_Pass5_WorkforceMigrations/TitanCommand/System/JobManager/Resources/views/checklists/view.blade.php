namespace App\Extensions\TitanCommand\System\JobManager\Resources\views\checklists;
...
<div class="container" style="max-width:820px">
  <div class="d-flex justify-content-between align-items-center">
    ...
    <a class="btn btn-outline-secondary btn-sm" href="{{ route('jobmanager.checklists.picker',$woId) }}">Choose template</a>
  </div>
  @if(!$wc)
    ...
    <table class="table table-sm align-middle mt-3">
      ...
      @foreach($items as $i)
        <tr>
          ...
          <td>
            <form method="post" action="{{ route('jobmanager.checklists.items.update', [$woId,$i->id]) }}" class="d-flex gap-2">@csrf
