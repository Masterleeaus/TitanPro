...
namespace App\Extensions\TitanCommand\System\JobManager\Http\Controllers; use Illuminate\Routing\Controller; use Illuminate\Support\Facades\DB; use Barryvdh\DomPDF\Facade\Pdf; use App\Extensions\TitanCommand\System\JobManager\Services\BrandingService;
class QaPdfController extends Controller{
  public function show($id){
    ...
    $brand=BrandingService::get(); $html=view('jobmanager::pdf.qa', compact('wo','wc','items','brand'))->render();
