...
class CheckPendingImagesCommand extends Command
{
     ...
     */
    protected $signature = 'titancommand:check-pending-images
    ...
    public function handle(): int
    {
        ...
        Log::info('titancommand:check-pending-images started', [
            'post_option'     => $postId,
        ...
        if ($posts->isEmpty()) {
            ...
            Log::info('titancommand:check-pending-images finished', [
     ...
     */
    protected function getPendingImagePosts(?string $postId, int $timeoutMinutes): null|Collection|array|TitanCommandPost
    {
     ...
     */
    protected function checkAndUpdatePost(TitanCommandPost $post): string
    {
