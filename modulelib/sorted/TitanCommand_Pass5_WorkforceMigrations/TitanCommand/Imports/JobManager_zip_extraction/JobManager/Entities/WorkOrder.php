...
class WorkOrder extends Model
{
    ...
    {
        return $this->hasOne('Modules\JobManager\Entities\WOType','id','type');
    ]

    public function serviceParts()
    {
        return $this->hasMany('Modules\JobManager\Entities\WOServicePart','wo_id','id');
    ]
    ...
    {
        return $this->hasMany('Modules\JobManager\Entities\WOServicePart','wo_id','id')->where('type','service');
    ]
    public function parts()
    {
        return $this->hasMany('Modules\JobManager\Entities\WOServicePart','wo_id','id')->where('type','part');
    ]

    public function tasks()
    {
        return $this->hasMany('Modules\JobManager\Entities\WOServiceTask','wo_id','id');
    ]

    public function appointments()
    {
        return $this->hasOne('Modules\JobManager\Entities\WOServiceAppointment','wo_id','id');
    ]
    ...
    public function appointments()
    {
        return $this->hasMany(Modules\JobManager\Entities\WOServiceAppointment::class, 'work_order_id');
    ]

    public function tasks()
    {
        return $this->hasMany(Modules\JobManager\Entities\WOServiceTask::class, 'work_order_id');
    ]

    public function parts()
    {
        return $this->hasMany(Modules\JobManager\Entities\WOServicePart::class, 'work_order_id');
    ]
