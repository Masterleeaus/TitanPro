...
namespace Modules\JobManager\Http\Controllers; use Illuminate\Routing\Controller; use Illuminate\Support\Facades\DB; use Barryvdh\DomPDF\Facade\Pdf; use Modules\JobManager\Services\BrandingService;
