...
class AiTemplatePropmtTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $prompts= [
            ...
            ['id' => 1000, 'template_id' => 100, 'key' => "en-US", 'value' => "You are a construction safety specialist. Create a Safe Work Method Statement (SWMS) for the task described below.\n\nUse clear headings and sections: Scope of Works, Required PPE, Plant and Equipment, Hazards and Risks, Control Measures, Work Steps, Emergency Procedures, and Residual Risk.\n\nInsert the job and site details from the fields: ##job_name##, ##site_address##, ##task_description##, ##hazards##, ##controls##.\n\nWrite in Australian English suitable for tradies and supervisors."],

            ['id' => 1001, 'template_id' => 101, 'key' => "en-US", 'value' => "You are a licensed electrician and safety professional. Draft a Safe Work Method Statement (SWMS) for low-voltage electrical work.\n\nStructure the SWMS with sections: Scope, References/Standards, PPE, Isolation and Lock-out, Test Before Touch, Hazards and Risks, Control Measures, Work Steps, and Emergency Response.\n\nUse the fields ##job_name##, ##site_address##, ##task_description##, ##hazards##, ##controls## to customise the document.\n\nUse practical wording understood by tradespeople and site supervisors."],

            ['id' => 1002, 'template_id' => 102, 'key' => "en-US", 'value' => "You are a civil construction safety specialist. Prepare a Safe Work Method Statement (SWMS) for excavation and trenching activities.\n\nInclude sections: Scope of Works, Underground Services and Dial Before You Dig, Ground Conditions, Plant and Equipment, Access/Egress, Hazards and Risks, Control Measures, Work Steps, and Emergency Procedures.\n\nUse the inputs ##job_name##, ##site_address##, ##task_description##, ##conditions##, ##hazards_controls##.\n\nWrite clearly and concisely, suitable for use on Australian construction sites."],

            ['id' => 1003, 'template_id' => 103, 'key' => "en-US", 'value' => "You are a construction safety advisor. Create a Safe Work Method Statement (SWMS) covering the use of common powered hand tools and equipment.\n\nCover at least: Scope, Tools Involved, PPE, Training and Competency, Hazards and Risks (kickback, noise, dust, vibration, cords, guarding), Control Measures, Work Steps and Housekeeping requirements.\n\nUse the fields ##job_name##, ##site_address##, ##tools##, ##task_description##, ##hazards_controls##.\n\nKeep the language practical and focused on risk controls."],

            ['id' => 1004, 'template_id' => 104, 'key' => "en-US", 'value' => "You are a construction supervisor. Draft a one-page Site Safety Briefing for a toolbox talk or induction.\n\nUse headings: Project/Site, Date, Attendees, Key Topics, High-Risk Activities Today, Controls to be Checked, and Actions/Follow-ups.\n\nInsert details from ##project_name##, ##date##, ##attendees##, ##topics##, ##actions##.\n\nWrite in dot points where helpful and keep it clear and easy to read on site."],

            ['id' => 1005, 'template_id' => 105, 'key' => "en-US", 'value' => "You are a professional builder. Draft a client-facing Scope of Works letter.\n\nThe letter should have sections: Introduction, Project Overview, Scope of Works, Inclusions, Exclusions, Assumptions and Next Steps.\n\nUse plain English that a homeowner can understand.\n\nInsert details from ##client_name##, ##project_name##, ##scope_summary##, ##inclusions##, ##exclusions## and keep the tone professional but friendly."],


            ['id' => 1006, 'template_id' => 106, 'key' => "en-US", 'value' => "You are a construction safety specialist. Prepare a Safe Work Method Statement (SWMS) for roofing works.\n\nUse headings such as: Scope of Works, Roof Type, PPE, Access and Edge Protection, Fragile Surfaces, Weather, Hazards and Risks, Control Measures, Work Steps, and Emergency Procedures.\n\nUse details from ##job_name##, ##site_address##, ##roof_type##, ##task_description##, ##hazards_controls##.\n\nWrite in clear Australian English so that roofers and supervisors can easily follow it."],

            ['id' => 1007, 'template_id' => 107, 'key' => "en-US", 'value' => "You are a concreter and safety advisor. Draft a Safe Work Method Statement (SWMS) for concrete and slab works.\n\nInclude: Scope, Element (slab/footing/path), Pre-pour Checks, PPE, Plant and Equipment, Hazards and Risks (pump hoses, slips, manual handling, vibration, chemical burns), Control Measures, Work Steps, and Curing/Finishing considerations.\n\nUse the fields ##job_name##, ##site_address##, ##element##, ##task_description##, ##hazards_controls##."],

            ['id' => 1008, 'template_id' => 108, 'key' => "en-US", 'value' => "You are a plumbing contractor with strong WHS knowledge. Create a SWMS for domestic plumbing and drainage works.\n\nStructure it with: Scope, PPE, Plant and Tools, Hazards and Risks (confined spaces, hot works, heights, biological hazards), Control Measures, Work Steps and Emergency Procedures.\n\nMake use of ##job_name##, ##site_address##, ##task_description##, ##hazards_controls## and keep the wording practical."],

            ['id' => 1009, 'template_id' => 109, 'key' => "en-US", 'value' => "You are a carpenter and construction safety specialist. Create a SWMS for carpentry and framing works.\n\nUse headings: Scope of Works, PPE, Plant and Tools, Hazards and Risks (falls, nail guns, saws, manual handling, noise, dust), Control Measures, Work Steps, and Housekeeping.\n\nUse the inputs ##job_name##, ##site_address##, ##task_description##, ##hazards_controls##."],

            ['id' => 1010, 'template_id' => 110, 'key' => "en-US", 'value' => "You are a site supervisor. Draft a clear and concise daily site diary entry.\n\nUse sections: Project/Site, Date, Weather, Labour and Trades on Site, Plant and Equipment, Key Activities, Delays/Issues, and Notes.\n\nUse the values ##project_name##, ##date##, ##weather##, ##labour##, ##activities##.\n\nWrite in bullet points where helpful."],

            ['id' => 1011, 'template_id' => 111, 'key' => "en-US", 'value' => "You are a builder preparing a variation / change order notice.\n\nFormat the document with headings: Parties, Project, Description of Variation, Reason for Variation, Cost Impact, Time Impact, and Acceptance.\n\nUse the fields ##recipient##, ##project_name##, ##variation_desc##, ##variation_reason##, ##variation_impact## and keep the tone professional but firm."],

            ['id' => 1012, 'template_id' => 112, 'key' => "en-US", 'value' => "You are a building inspector or supervisor. Prepare a defect / punch list for the project.\n\nInclude: Project/Site, Date, Area/Room, Defect or Item, Recommended Action, Responsibility and Due Date.\n\nUse the inputs ##project_name##, ##date##, ##area##, ##defects##, ##responsibility## and lay them out clearly so they can be copied into a table or checklist."],


            ['id' => 3781, 'template_id' => 113, 'key' => "en-US", 'value' => "You are a scaffolding supervisor. Prepare a Safe Work Method Statement (SWMS) for scaffolding and mobile scaffold tower work.\n\nInclude sections: Scope of Works, Scaffold Type, PPE, Plant and Equipment, Hazards and Risks (falls, collapse, falling objects, overloading), Control Measures, Work Steps (erection, use, modification, dismantle) and Emergency Procedures.\n\nUse the inputs ##job_name##, ##site_address##, ##scaffold_type##, ##task_description##, ##hazards_controls## and write in practical Australian English."],

            ['id' => 3782, 'template_id' => 114, 'key' => "en-US", 'value' => "You are a demolition contractor and safety advisor. Draft a SWMS for minor internal demolition and soft strip-out works.\n\nUse headings: Scope of Works, Existing Structures/Services, PPE, Plant and Equipment, Hazards and Risks (falling materials, hidden services, dust, noise, manual handling), Control Measures, Work Steps and Waste Handling.\n\nUse ##job_name##, ##site_address##, ##task_description##, ##existing_structures##, ##hazards_controls##."],

            ['id' => 3783, 'template_id' => 115, 'key' => "en-US", 'value' => "You are a WHS advisor. Create a SWMS focusing on manual handling and materials handling for building activities.\n\nCover: Scope, Materials/Loads, PPE, Hazards and Risks (strain injuries, awkward postures, repetitive tasks), Control Measures (mechanical aids, team lifts, work planning), Work Steps and Training Requirements.\n\nUse ##job_name##, ##site_address##, ##materials##, ##task_description##, ##hazards_controls## and keep the wording clear for trades and labourers."],

            ['id' => 3784, 'template_id' => 116, 'key' => "en-US", 'value' => "You are a site supervisor. Draft a concise pre-start or toolbox talk record for the day.\n\nInclude: Project/Site, Date, Attendees/Trades, Key Topics or Hazards discussed, and Agreed Actions/Follow-ups.\n\nUse ##project_name##, ##date##, ##attendees##, ##topics##, ##actions## to populate the content.\n\nLay it out so it can be easily copied into a one-page record."],

            ['id' => 3785, 'template_id' => 117, 'key' => "en-US", 'value' => "You are a builder inducting a worker onto a site. Create a site induction checklist summary that records the key items discussed.\n\nUse sections: Project/Site, Worker/Company, Induction Date, Key Induction Items (rules, amenities, emergency info, PPE), and Special Hazards/Notes.\n\nUse ##project_name##, ##worker##, ##date##, ##items##, ##notes## and write in clear bullet points where appropriate."],

            ['id' => 3786, 'template_id' => 118, 'key' => "en-US", 'value' => "You are a professional builder writing a client-facing cover letter to accompany a quote for building works.\n\nStructure the letter with: Greeting, Brief Project Summary, Key Inclusions/Highlights, Any Assumptions or Clarifications, and Next Steps/Call to Action.\n\nUse ##client_name##, ##project_name##, ##summary##, ##highlights##, ##next_steps## and keep the tone warm, clear and professional."],

            ['id' => 3787, 'template_id' => 119, 'key' => "en-US", 'value' => "You are a builder notifying a client of practical completion and handover.\n\nWrite a letter that covers: Project/Site, Practical Completion Date, Summary of Works Completed, Handover Items (keys, manuals, warranties), and Next Steps (defect period, contact details).\n\nUse ##client_name##, ##project_name##, ##completion_date##, ##summary##, ##handover_items## and keep the tone positive and professional."],

            ['id' => 3788, 'template_id' => 120, 'key' => "en-US", 'value' => "You are a site supervisor completing a Non-Conformance Report (NCR).\n\nInclude: Project/Site, NCR Number, Description of Non-Conformance, Immediate Action/Containment, and Corrective Action/Follow-up.\n\nUse ##project_name##, ##ncr_number##, ##description##, ##immediate_action##, ##corrective_action## and present the information clearly so it can be copied into an NCR form."],


            ['id' => 3789, 'template_id' => 121, 'key' => "en-US", 'value' => "You are a scaffolding and construction safety specialist. Draft a Safe Work Method Statement (SWMS) for scaffolding and edge protection works.\n\nInclude sections such as: Scope of Works, Scaffold / Edge Protection Type, PPE, Plant and Equipment, Hazards and Risks (falls, collapse, falling objects, weather), Control Measures, Work Steps, and Emergency Procedures.\n\nUse the details from ##job_name##, ##site_address##, ##scaffold_type##, ##task_description##, ##hazards_controls##.\n\nWrite in clear Australian English that is practical for scaffolders and supervisors."],

            ['id' => 3790, 'template_id' => 122, 'key' => "en-US", 'value' => "You are a traffic management and civil construction safety specialist. Prepare a Safe Work Method Statement (SWMS) for traffic and pedestrian management around road works.\n\nUse headings such as: Scope of Works, Traffic Conditions, PPE, Signage and Devices, Hazards and Risks (vehicle strikes, poor visibility, speeding traffic), Control Measures, Work Steps, and Emergency Procedures.\n\nUse ##job_name##, ##site_address##, ##traffic_conditions##, ##task_description##, ##hazards_controls## as inputs."],

            ['id' => 3791, 'template_id' => 123, 'key' => "en-US", 'value' => "You are a confined space safety specialist. Draft a Safe Work Method Statement (SWMS) for confined space entry.\n\nInclude: Scope of Works, Confined Space Description, PPE and Equipment, Hazards and Risks (atmosphere, engulfment, access/egress), Control Measures (testing, ventilation, permits, standby person), Work Steps, and Rescue / Emergency Plan.\n\nUse ##job_name##, ##site_address##, ##space_description##, ##hazards_controls##, ##rescue_plan##.\n\nDo not state that the SWMS is legally compliant – it is a template only."],

            ['id' => 3792, 'template_id' => 124, 'key' => "en-US", 'value' => "You are a demolition contractor and safety advisor. Prepare a Safe Work Method Statement (SWMS) for minor demolition and strip-out works.\n\nUse sections: Scope of Works, Structure / Area Description, PPE, Plant and Equipment, Hazards and Risks (falling materials, live services, dust, noise, manual handling), Control Measures, Work Steps, and Waste / Disposal.\n\nUse the details from ##job_name##, ##site_address##, ##structure_description##, ##task_description##, ##hazards_controls##."],

            ['id' => 3793, 'template_id' => 125, 'key' => "en-US", 'value' => "You are a site supervisor conducting a quality inspection. Draft a clear checklist-style narrative that can be pasted into a form.\n\nInclude sections such as: Project/Site, Date, Area/Location, Items Inspected, Observations/Defects, Actions/Follow-up.\n\nUse ##project_name##, ##date##, ##area##, ##items##, ##actions## to populate the content.\n\nWrite in short, factual bullet points where appropriate."],

            ['id' => 3794, 'template_id' => 126, 'key' => "en-US", 'value' => "You are a construction project lead preparing a pre-start meeting agenda. Draft a structured agenda for the meeting.\n\nInclude: Project/Site, Meeting Date, Attendees, Key Agenda Items (scope, programme, high-risk work, site rules), Actions/Decisions.\n\nUse ##project_name##, ##date##, ##attendees##, ##agenda_items##, ##actions##.\n\nKeep it practical and easy for supervisors and crews to follow."],
