...
use App\Extensions\TitanCommand\System\Services\Analysis\AgentInsightsService;
...
{
    protected $signature = 'titancommand:post-performance-advisor
    ...
    protected function buildMessages(TitanCommand $agent): array
    {
