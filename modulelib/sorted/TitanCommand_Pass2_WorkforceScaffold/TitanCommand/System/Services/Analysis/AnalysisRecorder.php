...
{
    public function recordForAgent(string $type, TitanCommand $agent, string $reportText): TitanCommandAnalysis
    {

        $analysis = TitanCommandAnalysis::create([
...
PROMPT;
    ...
    protected function notifyUser(TitanCommandAnalysis $analysis, TitanCommand $agent): void
    {
        $user = $agent->user;
