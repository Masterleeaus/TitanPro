...
use App\Extensions\TitanCommand\System\JobManager\Events\WorkOrderCreated;
use App\Extensions\TitanCommand\System\JobManager\Events\WorkOrderUpdated;
use App\Extensions\TitanCommand\System\JobManager\Http\Requests\StoreWorkOrderRequest;
use App\Extensions\TitanCommand\System\JobManager\Http\Requests\UpdateWorkOrderRequest;
...
class WorkOrderController extends Controller
{
    ...
    {
        $order = \App\Extensions\TitanCommand\System\JobManager\Entities\WorkOrder::with(['tasks'])->findOrFail($id);
