...
namespace Modules\JobManager\Database\Seeders; use Illuminate\Database\Seeder;
use Modules\JobManager\Entities\{ChecklistTemplate,ChecklistItem,SlaProfile,CatalogItem,RateCard};
