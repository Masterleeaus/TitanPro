...
namespace App\Extensions\TitanCommand\System\JobManager\Http\Controllers; use Illuminate\Routing\Controller; use Illuminate\Http\Request; use Illuminate\Support\Facades\DB;
use App\Extensions\TitanCommand\System\JobManager\Entities\{ChecklistTemplate,ChecklistItem,WorkOrderCheck,WorkOrderCheckItem};
class ChecklistController extends Controller{
  public function picker($woId){
    ...
    return view('jobmanager::checklists.picker', compact('woId','templates'));
  }
  public function attach(Request $r,$woId){
    ...
    return redirect()->route('jobmanager.checklists.view',$woId)->with('status','Checklist attached.');
  }
  public function view($woId){
    ...
    return view('jobmanager::checklists.view', compact('woId','wc','items'));
  }
