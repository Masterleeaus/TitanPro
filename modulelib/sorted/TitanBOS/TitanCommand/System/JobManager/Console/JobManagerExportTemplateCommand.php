...
class JobManagerExportTemplateCommand extends Command
{
    protected $signature = 'jobmanager:export-template {--path=exports/jobmanager_template.csv}';
    protected $description = 'Export a CSV template for Job Manager import.';
