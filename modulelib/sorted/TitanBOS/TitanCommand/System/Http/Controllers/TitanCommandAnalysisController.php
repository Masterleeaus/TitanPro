...
use App\Extensions\TitanCommand\System\Models\TitanCommandAnalysis;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use Illuminate\Support\Str;

class TitanCommandAnalysisController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $query = TitanCommandAnalysis::query()
            ->with('agent:id,name')
        ...
        $data = $analyses->getCollection()
            ->map(fn (TitanCommandAnalysis $analysis) => $this->transform($analysis))
            ->values();
    ...
    public function show(Request $request, TitanCommandAnalysis $analysis): JsonResponse
    {
    ...
    public function markAsRead(Request $request, TitanCommandAnalysis $analysis): JsonResponse
    {
        $this->authorizeAccess($request, $analysis);
    ...
    public function destroy(Request $request, TitanCommandAnalysis $analysis): JsonResponse
    {
        $this->authorizeAccess($request, $analysis);
    ...
    public function clearAll(Request $request): JsonResponse
    {
        ...
        $deleted = TitanCommandAnalysis::query()
    ...
    private function authorizeAccess(Request $request, TitanCommandAnalysis $analysis): void
    {
    ...
    private function transform(TitanCommandAnalysis $analysis): array
    {
        $link = null;
