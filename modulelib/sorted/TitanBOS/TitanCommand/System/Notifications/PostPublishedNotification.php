...
namespace App\Extensions\TitanCommand\System\Notifications;
...
class PostPublishedNotification extends Notification
{
    ...
    protected TitanCommandPost $post;

    protected bool $isSuccess;

    protected ?string $errorMessage;

    public function __construct(TitanCommandPost $post, bool $isSuccess = true, ?string $errorMessage = null)
    {
        $this->post = $post;
