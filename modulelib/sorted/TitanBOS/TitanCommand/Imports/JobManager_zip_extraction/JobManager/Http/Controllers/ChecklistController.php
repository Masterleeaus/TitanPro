...
namespace Modules\JobManager\Http\Controllers; use Illuminate\Routing\Controller; use Illuminate\Http\Request; use Illuminate\Support\Facades\DB;
use Modules\JobManager\Entities\{ChecklistTemplate,ChecklistItem,WorkOrderCheck,WorkOrderCheckItem};
