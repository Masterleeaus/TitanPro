...
namespace Modules\JobManager\Http\Controllers; use Illuminate\Routing\Controller; use Illuminate\Support\Facades\DB; use Modules\JobManager\Listeners\WorkOrderAutoInvoiceListener;
