...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('ext_titan_command_agent_posts', function (Blueprint $table) {
            $table->id();
            $table->foreignId('agent_id')
                ->constrained('ext_titan_command_agents')
                ->cascadeOnDelete();
            ...
            // Publishing Details
            $table->string('platform_post_id')->nullable(); // ID from titan command platform
    ...
    {
        Schema::dropIfExists('ext_titan_command_agent_posts');
    }
};
