...
>
    <div class="relative">
        <figure>
            <img
                ...
                src="{{ asset('vendor/command-agent/images/img-1.png') }}"
                width="571"
                height="572"
            >
        </figure>
        <figure class="absolute start-10 top-16">
            <img
                ...
                src="{{ asset('vendor/command-agent/images/img-2.png') }}"
                width="162"
                height="209"
            >
        </figure>
    ...
    <h2 class="mb-7 text-[21px] font-medium leading-[1.2em]">
        @lang('<span class="opacity-50">Hey 👋. I’m your AI Channels Agent. From planning to Confirming, I help you create, schedule, and</span> optimise social sub-items with intelligent performance insights.')
    </h2>
    ...
    <p class="text-[12px]">
        ...
        <a
            ...
            href="#"
        >
            @lang('Learn more about Channels Agent')
        </a>
    </p>
</div>
