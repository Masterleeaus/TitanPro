...
@push('css')
    <style>
        ...
        #command-agent-calendar .fc-header-toolbar .fc-button-group .fc-button {
            display: inline-grid;
            place-items: center;
            width: 20px;
            height: 20px;
        ...
        #command-agent-calendar .fc-header-toolbar .fc-button-group .fc-button:not(:disabled):hover {
            background-color: #fff;
            color: #000;
        }

        #command-agent-calendar .fc-col-header-cell-cushion {
            padding: 17px 10px;
            font-size: 14px;
            font-weight: 600;
            color: currentColor;
        ...
        #command-agent-calendar .fc-daygrid-event-harness {
            padding: 4px 4px 1px;
        }

        #command-agent-calendar .fc-daygrid-event {
            white-space: normal;
        }
        ...
        #command-agent-calendar .lqd-event-title,
        #command-agent-calendar .lqd-event-info {
            color: #fff;
        }

        #command-agent-calendar .fc-event:hover {
...
<div
    ...
    style="background-image: url({{ asset('vendor/command-agent/images/img-5.jpg') }})"
>
    <div
        class="min-h-[450px]"
        id="command-agent-calendar"
        x-data="Command AgentDashboardCalendar"
    >
        {{-- Skeleton loader --}}
...
@push('script')
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('Command AgentDashboardCalendar', () => ({
                calendar: null,
	...
	<figure class="lqd-event-container-image mb-2.5">
