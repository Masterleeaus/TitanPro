...
@section('content')
    <div @class(['px-5', 'py-5' => $theme !== 'command-agent-dashboard'])>
        @include('command-agent::agents.banner', ['determineAgentOfMonth' => $determineAgentOfMonth])
        @include('command-agent::agents.agents-grid', ['agents' => $agents, 'containers' => $containers])
    </div>
@endsection
