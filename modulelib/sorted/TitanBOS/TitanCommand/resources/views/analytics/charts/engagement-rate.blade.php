...
<div x-data='Command AgentEngagementRateChart'>
	<x-card class:body="px-6">
		...
		<div
			class="min-h-56"
			id="command-agent-engagement-rate-chart"
		>
...
@push('script')
	<script>
		document.addEventListener('alpine:init', () => {
			Alpine.data('Command AgentEngagementRateChart', () => ({
				chartData: @json($chart_data),
				activeFilter: "{{ $initialFilter }}",
				chart: null,
				chartEl: document.querySelector('#command-agent-engagement-rate-chart'),
