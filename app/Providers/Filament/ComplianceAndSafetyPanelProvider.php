...
use App\Filament\ComplianceAndSafety\Pages\Dashboard;
...
/**
 * COMPLIANCE & SAFETY launcher panel scaffold.
 * Safety, Compliance & Risk Controls
 */
class ComplianceAndSafetyPanelProvider extends PanelProvider
{
    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->brandName(fn () => app(OrganizationBrandingResolver::class)->panelName('Compliance & Safety'))
            ...
            ->discoverPages(in: app_path('Filament/ComplianceAndSafety/Pages'), for: 'App\Filament\ComplianceAndSafety\Pages')
            ->pages([
                Dashboard::class,
            ])
            ->discoverWidgets(in: app_path('Filament/ComplianceAndSafety/Widgets'), for: 'App\Filament\ComplianceAndSafety\Widgets')
            ->widgets([
