...
use App\Filament\DocsAndContracts\Pages\Dashboard;
...
/**
 * DOCS & CONTRACTS launcher panel scaffold.
 * Documents, Contracts & Agreements
 */
class DocsAndContractsPanelProvider extends PanelProvider
{
    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ->id('docscontracts')
            ->path('docscontracts')
            ->brandName(fn () => app(OrganizationBrandingResolver::class)->panelName('Docs & Contracts'))
            ...
            ->discoverPages(in: app_path('Filament/DocsAndContracts/Pages'), for: 'App\Filament\DocsAndContracts\Pages')
            ->pages([
                Dashboard::class,
            ])
            ->discoverWidgets(in: app_path('Filament/DocsAndContracts/Widgets'), for: 'App\Filament\DocsAndContracts\Widgets')
            ->widgets([
