...
class ItemResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Add-on Details')->columnSpanFull()->columns(1)->schema([
                ...
                Select::make('attachableServices')
                    ->label('Attachable Services')
                    ->relationship(
                        name: 'attachableServices',
                        titleAttribute: 'name',
                ...
                Toggle::make('is_upsell')->label('Upsell Visibility')->default(true),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                SelectFilter::make('pricing_type')->label('Pricing Type')->options(['flat' => 'Flat', 'per_m2' => 'Per m²', 'per_unit' => 'Per unit']),
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        return parent::getEloquentQuery()->withoutGlobalScopes([SoftDeletingScope::class])->where('organization_id', $organizationId);
    }
}
