...
class ContactLists extends Page
{
    ...
    protected static ?string $title = 'Contact Lists';

    protected static ?string $slug = 'contact-lists';
    ...
    public function pageConfig(): array
    {
        return [
            ...
            'description' => 'Use this area to manage the TitanNexus workflow records assigned to Contact Lists.',
            'table' => null,
            'columns' => [],
            'metrics' => [],
            'instructions' => [
