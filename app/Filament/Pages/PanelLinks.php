...
class PanelLinks extends Page
{
    ...
    {
        $this->activePreset = $this->storedPreset() ?? 'violet-executive';
        ...
        return [
            Action::make('applyPreset')
                ...
                ->form([
                    Select::make('preset')
                        ->label('Preset')
                        ->options(ThemePalette::presetOptions())
                        ->default($this->activePreset)
                        ->required(),
                ])
